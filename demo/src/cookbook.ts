...
export const COOKBOOK: TutorialEntry[] = [
  ...
  entry("flashcards-sqlite", {
    ...
    title: "AI Flashcards That Persist",
    subtitle: "Pattern 5 · Persistence",
    ...
    steps: [
      ...
      { atMs: 11200, label: "Read back & show", focus: "preview", zoom: 1.7 },
    ],
    captions: [
      { fromMs: 1400, toMs: 4000, text: "A topic fills the prompt that asks for a deck of cards." },
      { fromMs: 4100, toMs: 9000, text: "A Data Generator streams structured flashcards into one Code node." },
      { fromMs: 11200, toMs: 15500, text: "The script saves the deck and reads it back — data you can recall any time." },
    ],
    outroTitle: "Give workflows memory",
    outroPoints: [
      "Append to a workspace file, then read it back",
