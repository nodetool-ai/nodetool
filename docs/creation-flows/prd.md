...
**Historical sixth flow:** [game-prd.md](game-prd.md) — the former Godot game flow. The [built-in game engine design](../plans/builtin-game-engine-design.md) replaces it.
