...
| image | `any` | The input image to be transformed. | `{'type': 'image', 'uri': '', 'asset_id': None, 'data': None}` |
| strength | `any` | Similarity to the input image | `0.5` |
...
| control_image | `any` | The control image to guide the transformation. | `{'type': 'image', 'uri': '', 'asset_id': None, 'data': None}` |
