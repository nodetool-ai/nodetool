...
Directing a new piece belongs to [storyboard-core](../storyboard-core/SKILL.md)
...
npm run dev:nodetool -- timeline debug <id> --interact '[{"tool":"add_track","input":{"type":"audio","name":"Music"}}]'
npm run dev:nodetool -- timeline versions list <timeline_id> --save-type manual
```
...
- [docs/harnesses.md § nodetool timeline validate / debug](../../../docs/harnesses.md#nodetool-timeline-validate--debug-timeline-harness)
- [docs/harnesses.md § Generated mattes](../../../docs/harnesses.md#generated-mattes)
- [docs/harnesses.md § Audio-driven timeline motion](../../../docs/harnesses.md#audio-driven-timeline-motion)
- [storyboard-core tool contract § Timeline](../storyboard-core/references/tool-contract.md#timeline)
