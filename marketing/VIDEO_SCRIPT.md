...
| 0:42–0:50 | Export & close | Click Export; the finished trailer plays full-frame for ~3s, then the NodeTool mark over a defocused canvas. | **Export a finished cut.** Then: **NodeTool — the agent-first creative workspace.** CTA line: Free & open source · nodetool.ai | "Export the finished cut. NodeTool is free and open source. Download it, and put every model on one canvas." |
