...
//   return (
//     <div
//       className={`flex items-center justify-center text-center select-none cursor-pointer bg-white shadow-lg transition-all duration-400 ${jetBrainsMono.className}`}
//       style={{
//         width: "200px",
//         height: "200px",
//         fontSize: "5em",
