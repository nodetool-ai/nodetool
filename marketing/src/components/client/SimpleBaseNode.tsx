...
// Simple property label component
const SimplePropertyLabel: React.FC<{ name: string }> = ({ name }) => {
...
const SimpleBaseNode: React.FC<SimpleBaseNodeProps> = ({
  ...
  const isConstantNode = metadata?.node_type.includes("constant");
          ...
          <div key={property.name} className="node-property">
            {isConstantNode ? (
              ...
              <div className="property-container">
                <SimplePropertyLabel name={property.name} />
