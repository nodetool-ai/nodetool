...
const integrations = [
  {
    ...
    icon: Bot,
    color: "text-blue-400",
    items: ["OpenAI GPT-5.4", "Claude Opus 4.8", "Gemini 3 Pro", "Ollama", "Llama", "Mistral", "Qwen"],
  },
  {
    category: "Image Generation",
    icon: Image,
    color: "text-pink-400",
    items: ["FLUX", "gpt-image", "Qwen Image", "Ideogram", "Stable Diffusion"],
  },
  {
    category: "Video & Audio",
    icon: Video,
    color: "text-amber-400",
    items: ["Veo 3.1", "Kling 2.5", "Seedance", "Wan 2.5", "Runway", "ElevenLabs", "Suno", "Whisper"],
  },
  {
