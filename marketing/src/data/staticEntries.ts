...
export const staticEntries: PageEntry[] = [
  { route: "/", title: "NodeTool", description: "The agent-first creative workspace.", priority: 1.0, changeFrequency: "weekly", indexable: true },
  ...
  { route: "/studio", title: "NodeTool Studio", description: "Open-source agent-first creative workspace for your desktop. Agents build and revise; you inspect and edit.", priority: 0.9, changeFrequency: "weekly", indexable: true },
