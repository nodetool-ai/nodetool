...
- [ ] Hero 3-stage pipeline video (16:9 + 9:16)
- [ ] Five surface micro-loops (storyboard, script, timeline, sketch, 3D)
- [ ] Five-tab chaos animation
- [ ] MCP architecture schematic
- [ ] GitHub banner, OG cards, Product Hunt kit
