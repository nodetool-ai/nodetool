...
- **Test Type Fixes (2026-01-17)**: Fixed TypeScript errors and lint issues in test files. Files: ResultsStore.ts, ResultsStore.test.ts, NodeFocusStore.test.ts, eslint.config.mjs
