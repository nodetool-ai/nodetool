...
- **Perf Fix: Component Memoization (2026-01-17)**: Added React.memo to 4 large container components (GlobalChat, Welcome, SettingsMenu, WorkflowAssistantChat). Fixed inline handlers in chat composer buttons.
