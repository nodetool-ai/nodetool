...
- **Performance Profiling (2026-01-17)**: Added visual performance profiling with timing breakdown and recommendations. Files: PerformanceProfileStore.ts, PerformancePanel.tsx, usePerformanceProfiler.ts
