...
- **Workflow Performance Profiler (2026-01-17)**: Analyzes workflow structure for bottlenecks, estimates execution time, identifies parallelizable nodes. Files: WorkflowProfilerStore.ts, useWorkflowProfiler.ts, WorkflowProfiler.tsx, NodeEditor.tsx
