...
- **Perf Fix: Inline Handler Memoization (2026-01-17)**: Memoized handlers in TableActions, NodeToolButtons, FileBrowserDialog, OpenOrCreateDialog. Added React.memo to Welcome, SettingsMenu. Files: TableActions.tsx, NodeToolButtons.tsx, FileBrowserDialog.tsx, OpenOrCreateDialog.tsx, Welcome.tsx, SettingsMenu.tsx
