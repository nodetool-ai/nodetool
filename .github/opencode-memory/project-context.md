...
### Zustand Store Subscription Fix (2026-01-21)

**What**: Fixed 4 components with inefficient store subscriptions - converted object selectors and full store destructuring to individual selectors.

**Files**: web/src/components/dashboard/GettingStartedPanel.tsx, content/Welcome/Welcome.tsx, panels/NotificationButton.tsx, workspaces/WorkspaceTree.tsx, menus/FoldersSettingsMenu.tsx

**Impact**: Components now only re-render when their specific data changes, not on any store update.
