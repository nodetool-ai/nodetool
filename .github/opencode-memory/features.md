...
- **Workflow Performance Profiler**: Analyzes workflow execution performance with real-time metrics, bottleneck detection, and optimization suggestions. Includes performance scoring, execution timeline visualization, and memory/compute estimation. (2026-01-19)
