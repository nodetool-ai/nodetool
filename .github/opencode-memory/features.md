...
- **Performance Profiler**: Analyze workflow performance with estimated runtime, memory usage, bottlenecks, and optimization suggestions with keyboard shortcut (Ctrl+P)
