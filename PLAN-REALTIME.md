...
- [ ] **Decide the Python package layout for realtime nodes.** Mirror the `nodetool-huggingface` precedent exactly so anyone who can build an HF node can build a realtime node:
