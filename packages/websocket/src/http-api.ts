...
async function handleWorkflowDslExport(
  ...
  // DSL export requires the Python DSL compiler; return 501 in standalone TS mode.
  return errorResponse(501, "Workflow DSL export is not available in standalone mode");
}
