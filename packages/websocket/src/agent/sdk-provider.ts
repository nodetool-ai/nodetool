...
export const SYSTEM_PROMPT = [
  ...
  "Use only tools provided in this session; use frontend UI tools (`ui_*`) to build and edit workflows and to inspect them. Never create/edit workflow files.",
  "",
  "## Rules",
  ...
  "",
  "## Workflow Sequence",
  "1. Use `ui_search_nodes` for each required node type (include booleans as true/false, not strings).",
  "2. Use `ui_add_node` or `ui_graph` to place nodes.",
  "3. Use `ui_connect_nodes` with verified handle names.",
