...
export function addArray(inputs: AddArrayInputs): DslNode<SingleOutput<number | number | unknown>> {
...
export function subtractArray(inputs: SubtractArrayInputs): DslNode<SingleOutput<number | number | unknown>> {
...
export function multiplyArray(inputs: MultiplyArrayInputs): DslNode<SingleOutput<number | number | unknown>> {
...
export function divideArray(inputs: DivideArrayInputs): DslNode<SingleOutput<number | number | unknown>> {
...
export function modulusArray(inputs: ModulusArrayInputs): DslNode<SingleOutput<number | number | unknown>> {
