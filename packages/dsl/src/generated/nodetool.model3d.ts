...
export function loadModel3DFile(
  inputs: LoadModel3DFileInputs
): DslNode<LoadModel3DFileOutputs, "output"> {
  return createNode(
...
export function saveModel3DFile(
  inputs: SaveModel3DFileInputs
): DslNode<SaveModel3DFileOutputs, "output"> {
  return createNode(
...
export function saveModel3D(
  inputs: SaveModel3DInputs
): DslNode<SaveModel3DOutputs, "output"> {
  return createNode(
...
export function formatConverter(
  inputs: FormatConverterInputs
): DslNode<FormatConverterOutputs, "output"> {
  return createNode(
...
export function getModel3DMetadata(
  inputs: GetModel3DMetadataInputs
): DslNode<GetModel3DMetadataOutputs> {
  return createNode(
...
export function transform3D(
  inputs: Transform3DInputs
): DslNode<Transform3DOutputs, "output"> {
  return createNode(
...
export function decimate(
  inputs: DecimateInputs
): DslNode<DecimateOutputs, "output"> {
  return createNode(
...
export function boolean3D(
  inputs: Boolean3DInputs
): DslNode<Boolean3DOutputs, "output"> {
  return createNode(
...
export function recalculateNormals(
  inputs: RecalculateNormalsInputs
): DslNode<RecalculateNormalsOutputs, "output"> {
  return createNode(
...
export function centerMesh(
  inputs: CenterMeshInputs
): DslNode<CenterMeshOutputs, "output"> {
  return createNode(
...
export function flipNormals(
  inputs: FlipNormalsInputs
): DslNode<FlipNormalsOutputs, "output"> {
  return createNode(
...
export function mergeMeshes(
  inputs: MergeMeshesInputs
): DslNode<MergeMeshesOutputs, "output"> {
  return createNode(
...
export function textTo3D(
  inputs: TextTo3DInputs
): DslNode<TextTo3DOutputs, "output"> {
  return createNode(
...
export function imageTo3D(
  inputs: ImageTo3DInputs
): DslNode<ImageTo3DOutputs, "output"> {
  return createNode(
