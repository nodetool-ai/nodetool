...
// Read Text File — lib.os.ReadTextFile
...
export function readTextFile(inputs: ReadTextFileInputs): DslNode<ReadTextFileOutputs, "output"> {
  return createNode("lib.os.ReadTextFile", inputs as Record<string, unknown>, { outputNames: ["output"], defaultOutput: "output" });
}

// Write Text File — lib.os.WriteTextFile
...
export function writeTextFile(inputs: WriteTextFileInputs): DslNode<WriteTextFileOutputs, "output"> {
  return createNode("lib.os.WriteTextFile", inputs as Record<string, unknown>, { outputNames: ["output"], defaultOutput: "output" });
}

// Read Binary File — lib.os.ReadBinaryFile
...
export function readBinaryFile(inputs: ReadBinaryFileInputs): DslNode<ReadBinaryFileOutputs, "output"> {
  return createNode("lib.os.ReadBinaryFile", inputs as Record<string, unknown>, { outputNames: ["output"], defaultOutput: "output" });
}

// Write Binary File — lib.os.WriteBinaryFile
...
export function writeBinaryFile(inputs: WriteBinaryFileInputs): DslNode<WriteBinaryFileOutputs, "output"> {
  return createNode("lib.os.WriteBinaryFile", inputs as Record<string, unknown>, { outputNames: ["output"], defaultOutput: "output" });
}
