...
const CAPABILITY_CATEGORY_SNAPSHOT: Record<string, PermissionCategory> = {
  ...
  browser_input_text: "external",
  browser_move_mouse: "external",
  browser_navigate: "external",
  browser_press_key: "external",
  browser_restart: "execute",
  browser_scroll: "external",
  browser_select_option: "external",
  browser_status: "read",
  browser_upload_asset: "external",
  browser_view: "read",
  build_game: "write",
  create_native_game: "write",
  build_native_game: "write",
  get_native_game: "read",
  publish_native_game: "write",
  install_native_game_asset: "write",
  playtest_native_game: "execute",
  ...
  get_generation: "read",
  get_provider_generation: "external",
  await_generation: "read",
  cancel_generation: "write",
  reconcile_generation: "external",
  get_entity: "read",
  ...
  list_model3ds: "read",
  set_game_setup: "write",
  set_workflow_setup: "write",
  update_game_design: "write",
  update_workflow_plan_step: "write",
  list_models: "read",
  list_nodes: "read",
  list_provider_generations: "external",
