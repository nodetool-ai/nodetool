...
> = {
  ...
  BlipForConditionalGeneration: "hf.image_to_text",
  Blip2ForConditionalGeneration: "hf.image_to_text",
  GitForCausalLM: "hf.image_to_text",
  VisionEncoderDecoderModel: "hf.image_to_text",
  Florence2ForConditionalGeneration: "hf.image_to_text",
  // Audio
...
export const _CONFIG_MODEL_TYPE_MAPPING: Readonly<Record<string, string>> = {
  ...
  "image-to-text": "hf.image_to_text",
  ...
  blip: "hf.image_to_text",
  "blip-2": "hf.image_to_text",
  blip_2: "hf.image_to_text",
  git: "hf.image_to_text",
  florence2: "hf.image_to_text",
  "vision-encoder-decoder": "hf.image_to_text",
  vision_encoder_decoder: "hf.image_to_text",
