...
/**
 * Pure path-string pre-validation used by node-graph file I/O nodes.
 *
...
export class ReadTextFileNode extends BaseNode {
  static readonly nodeType = "lib.os.ReadTextFile";
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const encoding = String(this.encoding ?? "utf-8") as BufferEncoding;
...
export class WriteTextFileNode extends BaseNode {
  static readonly nodeType = "lib.os.WriteTextFile";
...
export class ReadBinaryFileNode extends BaseNode {
  static readonly nodeType = "lib.os.ReadBinaryFile";
...
export class WriteBinaryFileNode extends BaseNode {
  static readonly nodeType = "lib.os.WriteBinaryFile";
