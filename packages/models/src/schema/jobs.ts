...
export const jobs = sqliteTable("nodetool_jobs", {
  ...
  suspension_state_json: jsonText<Record<string, unknown>>()("suspension_state_json"),
  suspension_metadata_json: jsonText<Record<string, unknown>>()("suspension_metadata_json"),
