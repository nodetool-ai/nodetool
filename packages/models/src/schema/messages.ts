...
export const messages = sqliteTable(
  "nodetool_messages",
  {
    ...
    // Provider-agnostic session continuation token (state after this turn),
    // written on the assistant message so multi-turn chats resume the upstream
    // session instead of replaying the whole transcript. See ProviderSession.
    provider_session: jsonText<ProviderSession>()("provider_session"),
