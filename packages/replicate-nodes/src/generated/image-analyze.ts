...
replicate, ai`;
  ...
  @prop({ type: "float", default: 1, description: "Temperature for use with nucleus sampling", min: 0.5, max: 1 })
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 1024, description: "Maximum number of tokens to generate. A word is generally 2-3 tokens", min: 0 })
  declare max_tokens: any;

  @prop({ type: "str", default: "", description: "Prompt to use for text generation" })
  declare prompt: any;

  @prop({ type: "float", default: 0.2, description: "Adjusts randomness of outputs, greater than 1 is random and 0 is deterministic", min: 0 })
  declare temperature: any;

  @prop({ type: "float", default: 1, description: "When decoding text, samples from the top p percentage of most likely tokens; lower to ignore less likely tokens", min: 0, max: 1 })
  declare top_p: any;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 256, description: "Maximum number of tokens to generate", min: 32, max: 1024 })
  ...
  @prop({ type: "float", default: 0.4, description: "Sampling temperature", min: 0.1, max: 2 })
  declare temperature: any;

  @prop({ type: "float", default: 0.7, description: "Top-p sampling probability", min: 0, max: 1 })
  declare top_p: any;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 8, description: "Maximum number of frames to sample from the video.", min: 1, max: 64 })
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 1, description: "Frames per second to sample from video", min: 0, max: 10 })
  declare fps: any;

  @prop({ type: "int", default: 180, description: "Maximum number of frames to process", min: 0, max: 256 })
  declare max_frames: any;

  @prop({ type: "int", default: 2048, description: "Maximum number of tokens to generate", min: 0, max: 4096 })
  declare max_new_tokens: any;

  @prop({ type: "str", default: "", description: "Text prompt to guide the model's response" })
  declare prompt: any;

  @prop({ type: "float", default: 0.2, description: "Sampling temperature", min: 0, max: 1 })
  declare temperature: any;

  @prop({ type: "float", default: 0.9, description: "Top-p sampling", min: 0, max: 1 })
  declare top_p: any;
