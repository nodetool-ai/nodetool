...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.5, description: "Balance the quality (lower number) and fidelity (higher number).", min: 0, max: 1 })
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 50, description: "Number of steps for EDM Sampling Schedule.", min: 1, max: 500 })
  ...
  @prop({ type: "float", default: 7.5, description: " Classifier-free guidance scale for prompts.", min: 1, max: 20 })
  declare s_cfg: any;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 30, description: "Density of the grain particles from 0 to 60", min: 0, max: 60 })
  ...
  @prop({ type: "int", default: 1, description: "Size of the grain particles from 1 to 5", min: 1, max: 5 })
  declare grain_size: any;

  @prop({ type: "int", default: 30, description: "Intensity of the grain effect from 0 to 60", min: 0, max: 60 })
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.2, description: "Color saturation level from 0 to 1. Higher values produce more vibrant colors.", min: 0, max: 1 })
