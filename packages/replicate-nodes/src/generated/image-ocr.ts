...
replicate, ai`;
  ...
  @prop({ type: "int", default: 0, description: "Maximum number of pages to process. Cannot be specified if page_range is set - these parameters are mutually exclusive", min: 1 })
