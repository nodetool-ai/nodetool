...
replicate, ai`;
  ...
  @prop({ type: "float", default: 4, description: "Factor to scale image by", min: 0, max: 10 })
  declare scale: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.35, description: "Creativity, try from 0.3 - 0.9", min: 0, max: 1 })
  ...
  @prop({ type: "float", default: 6, description: "HDR, try from 3 - 9", min: 1, max: 50 })
  declare dynamic: any;
  ...
  @prop({ type: "int", default: 18, description: "Number of denoising steps", min: 1, max: 100 })
  ...
  @prop({ type: "float", default: 0.6, description: "Resemblance, try from 0.3 - 1.6", min: 0, max: 3 })
  ...
  @prop({ type: "float", default: 0, description: "Sharpen the image after upscaling. The higher the value, the more sharpening is applied. 0 for no sharpening", min: 0, max: 10 })
  declare sharpen: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.25, description: "Denoising strength. 1 means total destruction of the original image", min: 0, max: 1 })
  declare creativity: any;
  ...
  @prop({ type: "float", default: 7, description: "Scale for classifier-free guidance", min: 0.1, max: 30 })
  declare guidance_scale: any;

  @prop({ type: "float", default: 0, description: "HDR improvement over the original image", min: 0, max: 1 })
  declare hdr: any;
  ...
  @prop({ type: "float", default: 0.75, description: "Conditioning scale for controlnet", min: 0, max: 1 })
  declare resemblance: any;
...
export class ruDallE_SR extends ReplicateNode {
  ...
  static readonly description = `Real-ESRGAN super-resolution model from ruGPT-Image
replicate, ai`;
  static readonly requiredSettings = ["REPLICATE_API_TOKEN"];
  static readonly metadataOutputTypes = {
    output: "image"
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.35, description: "Denoising strength. 1 means total destruction of the original image", min: 0.1, max: 1 })
  declare creativity: any;
  ...
  @prop({ type: "float", default: 0, description: "Scale for classifier-free guidance, should be 0.", min: 0, max: 30 })
  declare guidance_scale: any;
  ...
  @prop({ type: "float", default: 1, description: "Strength of the image's details", min: -5, max: 3 })
  declare lora_details_strength: any;

  @prop({ type: "float", default: 1.25, description: "Strength of the image's sharpness. We don't recommend values above 2.", min: -5, max: 10 })
  ...
  @prop({ type: "float", default: 0.85, description: "Conditioning scale for controlnet", min: 0, max: 1 })
  declare resemblance: any;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 80, description: "Compression quality for output (1-100)", min: 1, max: 100 })
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 8.5, description: "Scale for classifier-free guidance", min: 1, max: 50 })
  declare guidance_scale: any;
  ...
  @prop({ type: "int", default: 40, description: "Number of denoising steps", min: 1, max: 500 })
  declare num_inference_steps: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 1.1, description: "Conditioning Scale", min: 0.5, max: 1.5 })
  declare conditioning_scale: any;

  @prop({ type: "int", default: 20, description: "Denoise Steps", min: 10, max: 50 })
  declare denoise_steps: any;

  @prop({ type: "float", default: 7.5, description: "Guidance Scale", min: 0.5, max: 10 })
  declare guidance_scale: any;
  ...
  @prop({ type: "int", default: 2, description: "Upsample Scale", min: 1, max: 4 })
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0, description: "Choose the level of creativity for face enhancement from 0 to 1. Defaults to 0, and is ignored if face_enhancement is false.", min: 0, max: 1 })
  declare face_enhancement_creativity: any;

  @prop({ type: "float", default: 0.8, description: "Control how sharp the enhanced faces are relative to the background from 0 to 1. Defaults to 0.8, and is ignored if face_enhancement is false.", min: 0, max: 1 })
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 1, description: "Controls the number of image tiles processed simultaneously. Higher values may increase speed but require more GPU memory. Lower values use less memory but may increase processing time. Default is 1 for broad compatibility. Adjust based on your GPU capabilities for optimal performance.", min: 1, max: 8 })
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 8, description: "Maximum number of tiles to process in a single batch. Higher values may increase speed but require more GPU memory.", min: 1, max: 64 })
  declare max_batch_size: any;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 1, description: "Number of times the enhancement process is repeated by feeding the output back as input. This can refine the result but might also introduce over-enhancement issues.", min: 1, max: 10 })
  ...
  @prop({ type: "int", default: 50, description: "The number of enhancement iterations to perform. More steps might result in a clearer image but can also introduce artifacts.", min: 1, max: 100 })
  declare steps: any;

  @prop({ type: "int", default: 4, description: "Factor by which the input image resolution should be increased. For instance, a factor of 4 will make the resolution 4 times greater in both height and width.", min: 1, max: 4 })
