...
replicate, ai`;
  ...
  @prop({ type: "float", default: 2, description: "Scale factor for upscaling (will be capped if output will exceed 4K)", min: 1 })
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 81, description: "Number of frames per video chunk", min: 1, max: 121 })
