...
replicate, ai`;
  ...
  @prop({ type: "int", default: 50, description: "Number of inference steps", min: 10, max: 500 })
  declare ddim_steps: any;

  @prop({ type: "float", default: 3.5, description: "Scale for classifier free guidance", min: 1, max: 20 })
