...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0, description: "Sampling temperature between 0 and 1", min: 0, max: 1 })
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 0, description: "Number of speakers, leave empty to autodetect.", min: 1, max: 50 })
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 0, description: "Maximum number of speakers to diarize. Default: None", min: 1 })
  declare max_speakers: any;

  @prop({ type: "int", default: 0, description: "Minimum number of speakers to diarize. Default: None", min: 1 })
  declare min_speakers: any;

  @prop({ type: "int", default: 0, description: "Number of speakers to diarize. Default: infer", min: 1 })
  declare num_speakers: any;
