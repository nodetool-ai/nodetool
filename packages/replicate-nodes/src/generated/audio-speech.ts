...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.75, description: "Similarity boost setting (0.0 to 1.0)", min: 0, max: 1 })
  declare similarity_boost: any;

  @prop({ type: "float", default: 1, description: "Speed of speech (0.25 to 4.0)", min: 0.7, max: 1.2 })
  declare speed: any;

  @prop({ type: "float", default: 0.5, description: "Stability setting for voice generation (0.0 to 1.0)", min: 0, max: 1 })
  declare stability: any;

  @prop({ type: "float", default: 0, description: "Style exaggeration (0.0 to 1.0)", min: 0, max: 1 })
  declare style: any;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 10000, description: "Target duration of the music in milliseconds (optional, defaults to ~10 seconds)", min: 5000, max: 300000 })
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0, description: "Speaking speed multiplier. Set to 0 for normal speed (1.0).", min: 0, max: 1.5 })
  declare speaking_rate: any;

  @prop({ type: "float", default: 1, description: "Controls randomness when generating audio. Higher values produce more expressive results, lower values are more deterministic.", min: 0, max: 2 })
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 1, description: "Speech speed multiplier (0.5 = half speed, 2.0 = double speed)", min: 0.1, max: 5 })
  declare speed: any;
...
replicate, ai`;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const text = String(this.text ?? "Hi there, I'm your new voice clone. Try your best to upload quality audio");
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 1200, description: "Maximum number of tokens to generate", min: 100, max: 2000 })
  declare max_new_tokens: any;

  @prop({ type: "float", default: 1.1, description: "Repetition penalty", min: 1, max: 2 })
  declare repetition_penalty: any;

  @prop({ type: "float", default: 0.6, description: "Temperature for generation", min: 0.1, max: 1.5 })
  declare temperature: any;

  @prop({ type: "str", default: "", description: "Text to convert to speech" })
  declare text: any;

  @prop({ type: "float", default: 0.95, description: "Top P for nucleus sampling", min: 0.1, max: 1 })
  declare top_p: any;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 10000, description: "Maximum audio length in milliseconds", min: 1000, max: 30000 })
...
replicate, ai`;
  ...
  async process(): Promise<Record<string, unknown>> {
    const apiKey = getReplicateApiKey(this._secrets);
    const description = String(this.description ?? "A female speaker with a slightly low-pitched voice delivers her words quite expressively, in a very confined sounding environment with clear audio quality. She speaks very fast.");
...
replicate, ai`;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const voicecraftModel = String(this.voicecraft_model ?? "giga330M_TTSEnhanced.pth");
...
replicate, ai`;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const speed = Number(this.speed ?? 1);
    const text = String(this.text ?? "Did you ever hear a folk tale about a giant turtle?");
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 1, description: "Speed of the generated audio", min: 0.1, max: 3 })
  declare speed: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.5, description: "CFG/Pace weight", min: 0.2, max: 1 })
  declare cfg_weight: any;

  @prop({ type: "float", default: 0.5, description: "Exaggeration (Neutral = 0.5, extreme values can be unstable)", min: 0.25, max: 2 })
  ...
  @prop({ type: "float", default: 0.8, description: "Temperature", min: 0.05, max: 5 })
  declare temperature: any;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const audioPromptRef = this.audio_prompt as Record<string, unknown> | undefined;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.5, description: "CFG/Pace weight controlling generation guidance (0.2-1.0). Use 0.5 for balanced results, 0 for language transfer", min: 0.2, max: 1 })
  declare cfg_weight: any;

  @prop({ type: "float", default: 0.5, description: "Controls speech expressiveness (0.25-2.0, neutral=0.5, extreme values may be unstable)", min: 0.25, max: 2 })
  declare exaggeration: any;
  ...
  @prop({ type: "float", default: 0.8, description: "Controls randomness in generation (0.05-5.0, higher=more varied)", min: 0.05, max: 5 })
  declare temperature: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.5, description: "Exaggeration (Neutral = 0.5, extreme values can be unstable)", min: 0.1, max: 1 })
  declare exaggeration: any;
  ...
  @prop({ type: "float", default: 0.8, description: "Temperature", min: 0.1, max: 5 })
  declare temperature: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 1.2, description: "Penalizes token repetition. Higher values reduce repetition.", min: 1, max: 2 })
  declare repetition_penalty: any;

  @prop({ type: "int", default: -1, description: "Random seed for reproducible results. Leave blank for random generation." })
  declare seed: any;

  @prop({ type: "float", default: 0.8, description: "Controls randomness in generation. Higher values produce more varied speech.", min: 0.05, max: 2 })
  declare temperature: any;
  ...
  @prop({ type: "int", default: 1000, description: "Top-k sampling. Limits vocabulary to top k tokens at each step.", min: 1, max: 2000 })
  declare top_k: any;

  @prop({ type: "float", default: 0.95, description: "Nucleus sampling threshold. Lower values make output more focused.", min: 0.5, max: 1 })
  declare top_p: any;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 0, description: "Semitone offset applied to the voice (−12 to +12).", min: -12, max: 12 })
  declare pitch: any;

  @prop({ type: "enum", default: 32000, values: ["8000", "16000", "22050", "24000", "32000", "44100"], description: "Audio sample rate in Hz." })
  declare sample_rate: any;

  @prop({ type: "float", default: 1, description: "Speech speed multiplier (0.5–2.0). Lower is slower, higher is faster.", min: 0.5, max: 2 })
  declare speed: any;
  ...
  @prop({ type: "float", default: 1, description: "Relative loudness. 1.0 is default MiniMax gain. Range 0–10.", min: 0, max: 10 })
  declare volume: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.7, description: "Text validation accuracy threshold (0-1)", min: 0, max: 1 })
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 1, description: "Classifier-free guidance scale (higher = more prompt adherence)", min: 1, max: 25 })
  declare cfg_scale: any;

  @prop({ type: "int", default: 190, description: "Duration of generated audio in seconds", min: 1, max: 190 })
  ...
  @prop({ type: "int", default: 8, description: "Number of diffusion steps (higher = better quality but slower)", min: 4, max: 8 })
  declare steps: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 60, description: "Duration of the generated audio in seconds. -1 means a random duration between 30 and 240 seconds.", min: 1, max: 240 })
  declare duration: any;

  @prop({ type: "float", default: 10, description: "Omega scale for APG guidance, or similar for other CFG types.", min: -100, max: 100 })
  declare granularity_scale: any;

  @prop({ type: "float", default: 0.5, description: "Guidance interval.", min: 0, max: 1 })
  declare guidance_interval: any;

  @prop({ type: "float", default: 0, description: "Guidance interval decay.", min: 0, max: 1 })
  declare guidance_interval_decay: any;

  @prop({ type: "float", default: 15, description: "Overall guidance scale.", min: 0, max: 30 })
  declare guidance_scale: any;

  @prop({ type: "enum", default: "apg", values: ["apg", "cfg", "cfg_star"], description: "Guidance type for CFG." })
  declare guidance_type: any;

  @prop({ type: "float", default: 0, description: "Guidance scale for lyrics.", min: 0, max: 10 })
  ...
  @prop({ type: "float", default: 3, description: "Minimum guidance scale.", min: 0, max: 100 })
  declare min_guidance_scale: any;

  @prop({ type: "int", default: 60, description: "Number of inference steps.", min: 10, max: 200 })
  ...
  @prop({ type: "float", default: 0, description: "Guidance scale for tags (text prompt).", min: 0, max: 10 })
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.9, description: "Top p for sampling", min: 0, max: 1 })
  declare top_p: any;

  @prop({ type: "int", default: 3, description: "Number of variations to generate", min: 1, max: 4 })
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const prompt = String(this.prompt ?? "80s electronic track with melodic synthesizers, catchy beat and groovy bass");
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 0, description: "End time of the audio file to use for chord conditioning. If None, will default to the end of the audio clip.", min: 0 })
  declare audio_end: any;

  @prop({ type: "int", default: 0, description: "Start time of the audio file to use for chord conditioning.", min: 0 })
  ...
  @prop({ type: "float", default: 1, description: "Coefficient value multiplied to multi-hot chord chroma.", min: 0.5, max: 2.5 })
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const audioChordsRef = this.audio_chords as Record<string, unknown> | undefined;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 1, description: "Coefficient value multiplied to multi-hot chord chroma.", min: 0.5, max: 2 })
  declare chroma_coefficient: any;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const musicInputRef = this.music_input as Record<string, unknown> | undefined;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 140, description: "Tempo in beats per minute", min: 40, max: 300 })
  declare bpm: any;

  @prop({ type: "int", default: 3, description: "Increases the influence of inputs on the output. Higher values produce lower-varience outputs that adhere more closely to inputs." })
  declare classifier_free_guidance: any;

  @prop({ type: "int", default: 8, description: "Maximum duration of the generated loop in seconds.", min: 2, max: 20 })
  ...
  @prop({ type: "int", default: 4, description: "Number of variations to generate", min: 1, max: 20 })
  declare variations: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 7, description: "Classifier-free guidance scale", min: 0, max: 20 })
  declare guidance_scale: any;
  ...
  @prop({ type: "int", default: 50, description: "Number of sampling steps", min: 1, max: 200 })
  declare steps: any;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const negativePrompt = String(this.negative_prompt ?? "low quality, gentle");
    const prompt = String(this.prompt ?? "The song is an epic blend of space-rock, rock, and post-rock genres.");
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 45, description: "Technical parameter for filtering audio generation tokens. Higher values allow more diverse sounds; lower values create more consistent audio.", min: 10, max: 100 })
  declare cfg_filter_top_k: any;

  @prop({ type: "float", default: 3, description: "Controls how closely the audio follows your text. Higher values (3-5) follow text more strictly; lower values may sound more natural but deviate more.", min: 1, max: 5 })
  declare cfg_scale: any;

  @prop({ type: "int", default: 10, description: "Maximum duration in seconds for the input voice cloning audio prompt. Only used when an audio prompt is provided. Longer voice samples will be truncated to this length.", min: 1, max: 120 })
  declare max_audio_prompt_seconds: any;

  @prop({ type: "int", default: 3072, description: "Controls the length of generated audio. Higher values create longer audio. (86 tokens ≈ 1 second of audio).", min: 500, max: 4096 })
  declare max_new_tokens: any;
  ...
  @prop({ type: "float", default: 1, description: "Adjusts playback speed of the generated audio. Values below 1.0 slow down the audio; 1.0 is original speed.", min: 0.5, max: 1.5 })
  declare speed_factor: any;

  @prop({ type: "float", default: 1.8, description: "Controls randomness in generation. Higher values (1.3-2.0) increase variety; lower values make output more consistent. Set to 0 for deterministic (greedy) generation.", min: 1, max: 2.5 })
  declare temperature: any;
  ...
  @prop({ type: "float", default: 0.95, description: "Controls diversity of word choice. Higher values include more unusual options. Most users shouldn't need to adjust this parameter.", min: 0.1, max: 1 })
  declare top_p: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 5, description: "Classifier-free guidance scale. Higher values follow conditioning more closely but may reduce creativity", min: 1, max: 20 })
  declare cfg_scale: any;
  ...
  @prop({ type: "int", default: 24, description: "Number of diffusion denoising steps. More steps = higher quality but slower generation", min: 10, max: 100 })
