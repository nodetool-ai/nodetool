...
replicate, ai`;
  ...
  @prop({ type: "int", default: 3, description: "If >=3: apply median filtering median filtering to the harvested pitch results.", min: 0, max: 7 })
  declare filter_radius: any;

  @prop({ type: "float", default: 0.5, description: "Control how much of the AI's accent to leave in the vocals.", min: 0, max: 1 })
  ...
  @prop({ type: "float", default: 0.33, description: "Control how much of the original vocals' breath and voiceless consonants to leave in the AI vocals. Set 0.5 to disable.", min: 0, max: 0.5 })
  declare protect: any;

  @prop({ type: "float", default: 0.7, description: "Absorption of high frequencies in the reverb.", min: 0, max: 1 })
  declare reverb_damping: any;

  @prop({ type: "float", default: 0.8, description: "Level of AI vocals without reverb.", min: 0, max: 1 })
  declare reverb_dryness: any;

  @prop({ type: "float", default: 0.15, description: "The larger the room, the longer the reverb time.", min: 0, max: 1 })
  declare reverb_size: any;

  @prop({ type: "float", default: 0.2, description: "Level of AI vocals with reverb.", min: 0, max: 1 })
  declare reverb_wetness: any;

  @prop({ type: "float", default: 0.25, description: "Control how much to use the original vocal's loudness (0) or a fixed loudness (1).", min: 0, max: 1 })
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0, description: "How much the CVVP model should influence the output. Increasing this can in some cases reduce the likelyhood of multiple speakers. Defaults to 0 (disabled)", min: 0, max: 1 })
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.3, description: "Only used for long text inputs or in case of reference speaker,             determines the timbre of the speaker. Use lower values to sample style based             on previous or reference speech instead of text.", min: 0, max: 1 })
  declare alpha: any;

  @prop({ type: "float", default: 0.7, description: "Only used for long text inputs or in case of reference speaker,             determines the prosody of the speaker. Use lower values to sample style based             on previous or reference speech instead of text.", min: 0, max: 1 })
  declare beta: any;

  @prop({ type: "int", default: 10, description: "Number of diffusion steps", min: 0, max: 50 })
  declare diffusion_steps: any;

  @prop({ type: "float", default: 1, description: "Embedding scale, use higher values for pronounced emotion", min: 0, max: 5 })
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.5, description: "Interpolation alpha if using two prompts. A value of 0 uses prompt_a fully, a value of 1 uses prompt_b fully", min: 0, max: 1 })
  declare alpha: any;

  @prop({ type: "float", default: 0.75, description: "How much to transform input spectrogram", min: 0, max: 1 })
  declare denoising: any;

  @prop({ type: "int", default: 50, description: "Number of steps to run the diffusion model", min: 1 })
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 0, description: "End time of the audio file to use for continuation. If -1 or None, will default to the end of the audio clip.", min: 0 })
  declare continuation_end: any;

  @prop({ type: "int", default: 0, description: "Start time of the audio file to use for continuation.", min: 0 })
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 4.5, description: "Guidance strength (CFG)", min: 1 })
  declare cfg_strength: any;

  @prop({ type: "float", default: 8, description: "Duration of output in seconds", min: 1 })
  declare duration: any;
  ...
  @prop({ type: "int", default: -1, description: "Random seed. Use -1 or leave blank to randomize the seed", min: -1 })
  declare seed: any;
