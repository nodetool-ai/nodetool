...
replicate, ai`;
  ...
  @prop({ type: "int", default: "", description: "Random seed. Use -1 or leave blank to randomize the seed" })
  declare seed: any;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: "", description: "Seed for random number generator. If None or -1, a random seed will be used." })
  declare seed: any;
  ...
  @prop({ type: "int", default: "", description: "End time of the audio file to use for continuation. If -1 or None, will default to the end of the audio clip." })
  ...
  async process(inputs: Record<string, unknown>): Promise<Record<string, unknown>> {
    ...
    const continuationEnd = Number(inputs.continuation_end ?? this.continuation_end ?? "");
