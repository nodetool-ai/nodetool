...
replicate, ai`;
  ...
  @prop({ type: "int", default: 1, description: "Number of image to generate", min: 0, max: 4 })
  ...
  @prop({ type: "int", default: 3, description: "Factor to scale image by (maximum: 4)", min: 0, max: 4 })
  declare scale: any;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const negativePrompt = String(this.negative_prompt ?? "low quality, out of frame, illustration, 3d, sepia, painting, cartoons, sketch, watermark, text, Logo, advertisement");
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 1, description: "The number of images to generate for each pose.", min: 1, max: 4 })
  declare number_of_images_per_pose: any;

  @prop({ type: "int", default: 3, description: "The number of images to generate.", min: 1, max: 20 })
  ...
  @prop({ type: "int", default: 80, description: "Quality of the output images, from 0 to 100. 100 is best quality, 0 is lowest quality.", min: 0, max: 100 })
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 1, description: "Number of images to generate", min: 1, max: 10 })
  ...
  async process(): Promise<Record<string, unknown>> {
    const apiKey = getReplicateApiKey(this._secrets);
    const checkpointModel = String(this.checkpoint_model ?? "general - dreamshaperXL_alpha2Xl10");
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 7.5, description: "Scale for classifier-free guidance", min: 1, max: 20 })
  declare guidance_scale: any;
  ...
  @prop({ type: "int", default: 50, description: "Number of denoising steps", min: 1, max: 500 })
  declare num_inference_steps: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 5, description: "The guidance scale tells the model how similar the output should be to the prompt.", min: 1, max: 10 })
  declare cfg: any;
  ...
  @prop({ type: "float", default: 0.85, description: "Prompt strength (or denoising strength) when using image to image. 1.0 corresponds to full destruction of information in image.", min: 0, max: 1 })
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 1, description: "The guidance scale tells the model how similar the output should be to the prompt.", min: 1, max: 10 })
  declare cfg: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.85, description: "Weight of the reference image. Larger values will make the reference image have a stronger influence on the generated image.", min: 0, max: 1 })
  ...
  @prop({ type: "float", default: 0.85, description: "Weight of the style reference image", min: 0, max: 1 })
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const characterReferenceRef = this.character_reference as Record<string, unknown> | undefined;
    ...
    const characterReferenceUrlRef = this.character_reference_url as Record<string, unknown> | undefined;
    ...
    const imageReferenceRef = this.image_reference as Record<string, unknown> | undefined;
    ...
    const imageReferenceUrlRef = this.image_reference_url as Record<string, unknown> | undefined;
    ...
    const styleReferenceRef = this.style_reference as Record<string, unknown> | undefined;
    ...
    const styleReferenceUrlRef = this.style_reference_url as Record<string, unknown> | undefined;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 7.5, description: "Scale for classifier-free guidance", min: 1, max: 50 })
  declare guidance_scale: any;

  @prop({ type: "int", default: 1024, description: "Height of output image" })
  declare height: any;

  @prop({ type: "float", default: 0.8, description: "For expert_ensemble_refiner, the fraction of noise to use", min: 0, max: 1 })
  declare high_noise_frac: any;

  @prop({ type: "image", default: "", description: "Input image for img2img or inpaint mode" })
  declare image: any;

  @prop({ type: "float", default: 0.6, description: "LoRA additive scale. Only applicable on trained models.", min: 0, max: 1 })
  ...
  @prop({ type: "int", default: 1, description: "Number of images to output.", min: 1, max: 4 })
  declare num_outputs: any;

  @prop({ type: "str", default: "An astronaut riding a rainbow unicorn", description: "Input prompt" })
  declare prompt: any;

  @prop({ type: "float", default: 0.8, description: "Prompt strength when using img2img / inpaint. 1.0 corresponds to full destruction of information in image", min: 0, max: 1 })
  declare prompt_strength: any;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const numInferenceSteps = Number(this.num_inference_steps ?? 50);
    const numOutputs = Number(this.num_outputs ?? 1);
    const prompt = String(this.prompt ?? "An astronaut riding a rainbow unicorn");
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 75, description: "Number of denoising steps", min: 1, max: 500 })
  declare num_inference_steps: any;

  @prop({ type: "int", default: 25, description: "Number of denoising steps for priors", min: 1, max: 500 })
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const numOutputs = Number(this.num_outputs ?? 1);
    const outputFormat = String(this.output_format ?? "webp");
    const prompt = String(this.prompt ?? "A moss covered astronaut with a black background");
    const seed = Number(this.seed ?? -1);
    const width = String(this.width ?? 512);
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 4, description: "Number of denoising steps. 4 is recommended, and lower number of steps produce lower quality outputs, faster.", min: 1, max: 4 })
  declare num_inference_steps: any;

  @prop({ type: "int", default: 1, description: "Number of outputs to generate", min: 1, max: 4 })
  declare num_outputs: any;

  @prop({ type: "enum", default: "webp", values: ["webp", "jpg", "png"], description: "Format of the output images" })
  declare output_format: any;

  @prop({ type: "int", default: 80, description: "Quality when saving the output images, from 0 to 100. 100 is best quality, 0 is lowest quality. Not relevant for .png outputs", min: 0, max: 100 })
  declare output_quality: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 3.5, description: "Guidance for generated image. Lower values can give more realistic images. Good values to try are 2, 2.5, 3 and 3.5", min: 0, max: 10 })
  ...
  @prop({ type: "int", default: 28, description: "Number of denoising steps. Recommended range is 28-50, and lower number of steps produce lower quality outputs, faster.", min: 1, max: 50 })
  declare num_inference_steps: any;
  ...
  @prop({ type: "float", default: 0.8, description: "Prompt strength when using img2img. 1.0 corresponds to full destruction of information in image", min: 0, max: 1 })
  declare prompt_strength: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 3, description: "Controls the balance between adherence to the text prompt and image quality/diversity. Higher values make the output more closely match the prompt but may reduce overall image quality. Lower values allow for more creative freedom but might produce results less relevant to the prompt.", min: 2, max: 5 })
  declare guidance: any;

  @prop({ type: "int", default: 0, description: "Height of the generated image in text-to-image mode. Only used when aspect_ratio=custom. Must be a multiple of 32 (if it's not, it will be rounded to nearest multiple of 32). Note: Ignored in img2img and inpainting modes.", min: 256, max: 1440 })
  declare height: any;
  ...
  @prop({ type: "float", default: 2, description: "Deprecated", min: 1, max: 4 })
  ...
  @prop({ type: "int", default: 2, description: "Safety tolerance, 1 is most strict and 6 is most permissive", min: 1, max: 6 })
  declare safety_tolerance: any;

  @prop({ type: "int", default: -1, description: "Random seed. Set for reproducible generation" })
  declare seed: any;

  @prop({ type: "int", default: 25, description: "Deprecated", min: 1, max: 50 })
  declare steps: any;

  @prop({ type: "int", default: 0, description: "Width of the generated image in text-to-image mode. Only used when aspect_ratio=custom. Must be a multiple of 32 (if it's not, it will be rounded to nearest multiple of 32). Note: Ignored in img2img and inpainting modes.", min: 256, max: 1440 })
  declare width: any;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const imagePromptRef = this.image_prompt as Record<string, unknown> | undefined;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.1, description: "Blend between the prompt and the image prompt.", min: 0, max: 1 })
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 50, description: "Number of diffusion steps. Higher values yield finer details but increase processing time.", min: 15, max: 50 })
  declare steps: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 60, description: "Controls the balance between adherence to the text prompt and image quality/diversity. Higher values make the output more closely match the prompt but may reduce overall image quality. Lower values allow for more creative freedom but might produce results less relevant to the prompt.", min: 1.5, max: 100 })
  declare guidance: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 10, description: "Guidance for generated image", min: 0, max: 100 })
  declare guidance: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 3.5, description: "Guidance scale for the diffusion process", min: 0, max: 10 })
  declare guidance_scale: any;

  @prop({ type: "int", default: 848, description: "Height of the generated image. Optional, only used when aspect_ratio=custom. Must be a multiple of 16 (if it's not, it will be rounded to nearest multiple of 16)", min: 256, max: 1440 })
  declare height: any;

  @prop({ type: "int", default: 8, description: "Number of inference steps", min: 1, max: 30 })
  declare num_inference_steps: any;
  ...
  @prop({ type: "int", default: 848, description: "Width of the generated image. Optional, only used when aspect_ratio=custom. Must be a multiple of 16 (if it's not, it will be rounded to nearest multiple of 16)", min: 256, max: 1440 })
  declare width: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 3, description: "Guidance scale for the diffusion process. Lower values can give more realistic images. Good values to try are 2, 2.5, 3 and 3.5", min: 0, max: 10 })
  declare guidance_scale: any;

  @prop({ type: "int", default: 0, description: "Height of generated image. Only works if 'aspect_ratio' is set to custom. Will be rounded to nearest multiple of 16. Incompatible with fast generation", min: 256, max: 1440 })
  declare height: any;
  ...
  @prop({ type: "int", default: 28, description: "Number of denoising steps. More steps can give more detailed images, but take longer.", min: 1, max: 50 })
  declare num_inference_steps: any;
  ...
  @prop({ type: "int", default: 0, description: "Width of generated image. Only works if 'aspect_ratio' is set to custom. Will be rounded to nearest multiple of 16. Incompatible with fast generation", min: 256, max: 1440 })
  declare width: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 30, description: "Guidance for generated image", min: 0, max: 100 })
  declare guidance: any;
...
replicate, ai`;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const reduxImageRef = this.redux_image as Record<string, unknown> | undefined;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 28, description: "Number of denoising steps. Recommended range is 28-50", min: 1, max: 50 })
  declare num_inference_steps: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.5, description: "controlnet conditioning scale for generalization", min: 0, max: 1 })
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const negativePrompt = String(this.negative_prompt ?? "low quality, bad quality, sketches");
    const numInferenceSteps = Number(this.num_inference_steps ?? 50);
    const prompt = String(this.prompt ?? "aerial view, a futuristic research complex in a bright foggy jungle, hard lighting");
    const seed = Number(this.seed ?? 0);
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.9, description: "controlnet conditioning scale for generalization", min: 0.3, max: 0.9 })
  declare condition_scale: any;
  ...
  @prop({ type: "int", default: 10, description: "Number of steps to refine", min: 0, max: 40 })
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0, description: "Scale for classifier-free guidance", min: 0, max: 50 })
  declare guidance_scale: any;

  @prop({ type: "int", default: 1024, description: "Height of output image. Recommended 1024 or 1280", min: 256, max: 1280 })
  declare height: any;

  @prop({ type: "str", default: "worst quality, low quality", description: "Negative Input prompt" })
  declare negative_prompt: any;

  @prop({ type: "int", default: 4, description: "Number of denoising steps. 4 for best results", min: 1, max: 10 })
  declare num_inference_steps: any;
  ...
  @prop({ type: "int", default: 1024, description: "Width of output image. Recommended 1024 or 1280", min: 256, max: 1280 })
  declare width: any;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const height = Number(this.height ?? 1024);
    const negativePrompt = String(this.negative_prompt ?? "worst quality, low quality");
    const numInferenceSteps = Number(this.num_inference_steps ?? 4);
    const numOutputs = Number(this.num_outputs ?? 1);
    const prompt = String(this.prompt ?? "self-portrait of a woman, lightning in the background");
    const scheduler = String(this.scheduler ?? "K_EULER");
    const seed = Number(this.seed ?? 0);
    const width = Number(this.width ?? 1024);
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 3, description: "Scale for classifier-free guidance", min: 0.1, max: 20 })
  declare guidance_scale: any;

  @prop({ type: "int", default: 1024, description: "Height of output image", min: 256, max: 1536 })
  declare height: any;
  ...
  @prop({ type: "int", default: 25, description: "Number of denoising steps", min: 1, max: 60 })
  declare num_inference_steps: any;
  ...
  @prop({ type: "int", default: 1024, description: "Width of output image", min: 256, max: 1536 })
  declare width: any;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const guidanceScale = Number(this.guidance_scale ?? 3);
    const height = Number(this.height ?? 1024);
    const negativePrompt = String(this.negative_prompt ?? "ugly, deformed, noisy, blurry, distorted");
    const numInferenceSteps = Number(this.num_inference_steps ?? 25);
    const numOutputs = Number(this.num_outputs ?? 1);
    const prompt = String(this.prompt ?? "Astronaut in a jungle, cold color palette, muted colors, detailed, 8k");
    const promptStrength = Number(this.prompt_strength ?? 0.8);
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 7.5, description: "Scale for classifier-free guidance. Recommended 7-8", min: 1, max: 50 })
  declare guidance_scale: any;
  ...
  @prop({ type: "int", default: 20, description: "Number of denoising steps. 20 to 35 steps for more detail, 20 steps for faster results.", min: 1, max: 100 })
  declare num_inference_steps: any;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const numInferenceSteps = Number(this.num_inference_steps ?? 20);
    const numOutputs = Number(this.num_outputs ?? 1);
    const prompt = String(this.prompt ?? "black fluffy gorgeous dangerous cat animal creature, large orange eyes, big fluffy ears, piercing gaze, full moon, dark ambiance, best quality, extremely detailed");
    const promptStrength = Number(this.prompt_strength ?? 0.8);
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 20, description: "Number of denoising steps. 20 to 60 steps for more detail, 20 steps for faster results.", min: 1, max: 100 })
  declare num_inference_steps: any;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const numInferenceSteps = Number(this.num_inference_steps ?? 20);
    const numOutputs = Number(this.num_outputs ?? 1);
    const prompt = String(this.prompt ?? "Anime full body portrait of a swordsman holding his weapon in front of him. He is facing the camera with a fierce look on his face. Anime key visual (best quality, HD, ~+~aesthetic~+~:1.2)");
    const promptStrength = Number(this.prompt_strength ?? 0.8);
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 90, description: "Quality of the output images, from 0 to 100. 100 is best quality, 0 is lowest quality.", min: 0, max: 100 })
  declare output_quality: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.65, description: "How much of the original image (and colors) to preserve (0 is all, 1 is none, 0.65 is a good balance)", min: 0, max: 1 })
  declare structure_denoising_strength: any;

  @prop({ type: "float", default: 1, description: "Strength of the depth controlnet", min: 0, max: 2 })
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const seed = Number(this.seed ?? -1);
    const structureDenoisingStrength = Number(this.structure_denoising_strength ?? 0.65);
    ...
    const structureImageRef = this.structure_image as Record<string, unknown> | undefined;
    ...
    const styleImageRef = this.style_image as Record<string, unknown> | undefined;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.75, description: "How strong the controlnet conditioning is", min: 0, max: 4 })
  declare controlnet_conditioning_scale: any;

  @prop({ type: "float", default: 1, description: "When controlnet conditioning ends", min: 0, max: 1 })
  declare controlnet_end: any;

  @prop({ type: "float", default: 0, description: "When controlnet conditioning starts", min: 0, max: 1 })
  declare controlnet_start: any;

  @prop({ type: "float", default: 7.5, description: "Scale for classifier-free guidance", min: 0.1, max: 30 })
  declare guidance_scale: any;
  ...
  @prop({ type: "int", default: 40, description: "Number of diffusion steps", min: 20, max: 100 })
  declare num_inference_steps: any;

  @prop({ type: "int", default: 1, description: "Number of outputs", min: 1, max: 4 })
  declare num_outputs: any;
  ...
  async process(): Promise<Record<string, unknown>> {
    const apiKey = getReplicateApiKey(this._secrets);
    const controlnetConditioningScale = Number(this.controlnet_conditioning_scale ?? 0.75);
    ...
    const negativePrompt = String(this.negative_prompt ?? "ugly, disfigured, low quality, blurry, nsfw");
    const numInferenceSteps = Number(this.num_inference_steps ?? 40);
    const numOutputs = Number(this.num_outputs ?? 1);
...
replicate, ai`;
  ...
  @prop({ type: "int", default: -1, description: "Random seed. Set for reproducible generation", max: 2147483647 })
  declare seed: any;
...
replicate, ai`;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const outputFormat = String(this.output_format ?? "jpg");
    const prompt = String(this.prompt ?? "");
    const safetyFilterLevel = String(this.safety_filter_level ?? "block_only_high");
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 3, description: "Guidance for generated image. Lower values can give more realistic images. Good values to try are 2, 2.5, 3 and 3.5", min: 0, max: 10 })
  declare guidance: any;
  ...
  @prop({ type: "int", default: 30, description: "Number of denoising steps. Recommended range is 28-50, and lower number of steps produce lower quality outputs, faster.", min: 1, max: 50 })
  declare num_inference_steps: any;
  ...
  @prop({ type: "float", default: 0.9, description: "Strength for img2img pipeline", min: 0, max: 1 })
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const extraLoraScale = this.extra_lora_scale ?? [];
    const extraLoraWeights = this.extra_lora_weights ?? [];
    const goFast = Boolean(this.go_fast ?? true);
    const guidance = Number(this.guidance ?? 3);
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 95, description: "Quality when saving the output images, from 0 to 100. 100 is best quality, 0 is lowest quality. Not relevant for .png outputs", min: 0, max: 100 })
  declare output_quality: any;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 2048, description: "Custom image height (only used when size='custom'). Range: 1024-4096 pixels.", min: 1024, max: 4096 })
  declare height: any;
  ...
  @prop({ type: "int", default: 1, description: "Maximum number of images to generate when sequential_image_generation='auto'. Range: 1-15. Total images (input + generated) cannot exceed 15.", min: 1, max: 15 })
  ...
  @prop({ type: "int", default: 2048, description: "Custom image width (only used when size='custom'). Range: 1024-4096 pixels.", min: 1024, max: 4096 })
  declare width: any;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const prompt = String(this.prompt ?? "");
    const sequentialImageGeneration = String(this.sequential_image_generation ?? "disabled");
    ...
    const imageInputRefs = Array.isArray(this.image_input) ? this.image_input : [];
    const imageInputUrls: string[] = [];
    for (const ref of imageInputRefs) {
      if (isRefSet(ref)) {
        const url = await assetToUrl(ref as Record<string, unknown>, apiKey);
        if (url) imageInputUrls.push(url);
      }
    }
    if (imageInputUrls.length) args["image_input"] = imageInputUrls;
    removeNulls(args);
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 1, description: "Number of images to generate", min: 1, max: 9 })
  declare number_of_images: any;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 0, description: "Height of the generated image. Only used when aspect_ratio=custom. Must be a multiple of 16 (if it's not, it will be rounded to nearest multiple of 16).", min: 256, max: 2048 })
  declare height: any;
  ...
  @prop({ type: "int", default: 2, description: "Safety tolerance, 1 is most strict and 5 is most permissive", min: 1, max: 5 })
  declare safety_tolerance: any;

  @prop({ type: "int", default: -1, description: "Random seed. Set for reproducible generation" })
  declare seed: any;

  @prop({ type: "int", default: 0, description: "Width of the generated image. Only used when aspect_ratio=custom. Must be a multiple of 16 (if it's not, it will be rounded to nearest multiple of 16).", min: 256, max: 2048 })
  declare width: any;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const inputImagesRefs = Array.isArray(this.input_images) ? this.input_images : [];
    const inputImagesUrls: string[] = [];
    for (const ref of inputImagesRefs) {
      if (isRefSet(ref)) {
        const url = await assetToUrl(ref as Record<string, unknown>, apiKey);
        if (url) inputImagesUrls.push(url);
      }
    }
    if (inputImagesUrls.length) args["input_images"] = inputImagesUrls;
    removeNulls(args);
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 4.5, description: "Guidance scale for generation. Controls how closely the output follows the prompt", min: 1.5, max: 10 })
  declare guidance: any;

  @prop({ type: "int", default: 0, description: "Height of the generated image. Only used when aspect_ratio=custom. Must be a multiple of 32 (if it's not, it will be rounded to nearest multiple of 32).", min: 256, max: 2048 })
  declare height: any;
  ...
  @prop({ type: "int", default: 30, description: "Number of inference steps", min: 1, max: 50 })
  declare steps: any;

  @prop({ type: "int", default: 0, description: "Width of the generated image. Only used when aspect_ratio=custom. Must be a multiple of 32 (if it's not, it will be rounded to nearest multiple of 32).", min: 256, max: 2048 })
  declare width: any;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 1, description: "Number of images to generate (1-10)", min: 1, max: 10 })
  declare number_of_images: any;

  @prop({ type: "str", default: "", description: "Your OpenAI API key (optional - uses proxy if not provided)" })
  declare openai_api_key: any;

  @prop({ type: "int", default: 90, description: "Compression level (0-100%)", min: 0, max: 100 })
...
replicate, ai`;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const styleReferenceImagesRefs = Array.isArray(this.style_reference_images) ? this.style_reference_images : [];
    const styleReferenceImagesUrls: string[] = [];
    for (const ref of styleReferenceImagesRefs) {
      if (isRefSet(ref)) {
        const url = await assetToUrl(ref as Record<string, unknown>, apiKey);
        if (url) styleReferenceImagesUrls.push(url);
      }
    }
    if (styleReferenceImagesUrls.length) args["style_reference_images"] = styleReferenceImagesUrls;
    removeNulls(args);
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 2, description: "Safety tolerance, 0 is most strict and 6 is most permissive. 2 is currently the maximum allowed when input images are used.", min: 0, max: 6 })
  declare safety_tolerance: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 2.5, description: "Prompt adherence. Higher = more literal.", min: 1, max: 10 })
  declare guidance_scale: any;

  @prop({ type: "int", default: 2048, description: "Image height", min: 512, max: 2048 })
  declare height: any;
  ...
  @prop({ type: "int", default: 2048, description: "Image width", min: 512, max: 2048 })
  declare width: any;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 0, description: "Guidance scale (1-10)", min: 3, max: 5 })
  declare guidance_scale: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0, description: "Guidance scale (1-10)", min: 3, max: 5 })
  declare guidance_scale: any;
...
replicate, ai`;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    for (const ref of imagesRefs) {
      if (isRefSet(ref)) {
        const url = await assetToUrl(ref as Record<string, unknown>, apiKey);
        if (url) imagesUrls.push(url);
      }
    }
    if (imagesUrls.length) args["images"] = imagesUrls;
    removeNulls(args);
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 4, description: "Set the guidance scale for text prompt influence (1.0-10.0)", min: 1, max: 10 })
  declare guidance_scale: any;

  @prop({ type: "int", default: 1152, description: "Set the height of the generated image (256-1536 pixels)", min: 256, max: 1536 })
  declare height: any;

  @prop({ type: "float", default: 1, description: "Set the weight of the ID image influence (0.0-3.0)", min: 0, max: 3 })
  ...
  @prop({ type: "int", default: 128, description: "Set the max sequence length for prompt (T5), smaller is faster (128-512)", min: 128, max: 512 })
  ...
  @prop({ type: "int", default: 1, description: "Set the number of images to generate (1-4)", min: 1, max: 4 })
  declare num_outputs: any;

  @prop({ type: "int", default: 20, description: "Set the number of denoising steps (1-20)", min: 1, max: 20 })
  declare num_steps: any;

  @prop({ type: "enum", default: "webp", values: ["png", "jpg", "webp"], description: "Choose the format of the output image" })
  declare output_format: any;

  @prop({ type: "int", default: 80, description: "Set the quality of the output image for jpg and webp (1-100)", min: 1, max: 100 })
  declare output_quality: any;
  ...
  @prop({ type: "int", default: 0, description: "Set the timestep to start inserting ID (0-4 recommended, 0 for highest fidelity, 4 for more editability)", min: 0, max: 10 })
  declare start_step: any;

  @prop({ type: "float", default: 1, description: "Set the Classifier-Free Guidance (CFG) scale. 1.0 uses standard CFG, while values >1.0 enable True CFG for more precise control over generation. Higher values increase adherence to the prompt at the cost of image quality.", min: 1, max: 10 })
  declare true_cfg: any;

  @prop({ type: "int", default: 896, description: "Set the width of the generated image (256-1536 pixels)", min: 256, max: 1536 })
  declare width: any;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const negativePrompt = String(this.negative_prompt ?? "bad quality, worst quality, text, signature, watermark, extra limbs, low resolution, partially rendered objects, deformed or partially rendered eyes, deformed, deformed eyeballs, cross-eyed, blurry");
    const numOutputs = Number(this.num_outputs ?? 1);
    ...
    const mainFaceImageRef = this.main_face_image as Record<string, unknown> | undefined;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 1.2, description: "CFG, recommend value range [1, 1.5], 1 will be faster", min: 1, max: 1.5 })
  ...
  @prop({ type: "float", default: 0.8, description: "ID scale", min: 0, max: 5 })
  declare identity_scale: any;

  @prop({ type: "int", default: 1024, description: "Height", min: 512, max: 2024 })
  declare image_height: any;

  @prop({ type: "int", default: 768, description: "Width", min: 512, max: 2024 })
  ...
  @prop({ type: "int", default: 4, description: "Num samples", min: 1, max: 8 })
  declare num_samples: any;

  @prop({ type: "int", default: 4, description: "Steps", min: 1, max: 100 })
  declare num_steps: any;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const auxiliaryFaceImage1Ref = this.auxiliary_face_image1 as Record<string, unknown> | undefined;
    ...
    const auxiliaryFaceImage2Ref = this.auxiliary_face_image2 as Record<string, unknown> | undefined;
    ...
    const auxiliaryFaceImage3Ref = this.auxiliary_face_image3 as Record<string, unknown> | undefined;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 2, description: "Safety tolerance, 0 is most strict and 2 is most permissive. 2 is currently the maximum allowed.", min: 0, max: 2 })
  declare safety_tolerance: any;
...
replicate, ai`;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const characterReferenceImageRef = this.character_reference_image as Record<string, unknown> | undefined;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 1, description: "CFG range end", min: 0, max: 1 })
  declare cfg_range_end: any;

  @prop({ type: "float", default: 0, description: "CFG range start", min: 0, max: 1 })
  declare cfg_range_start: any;

  @prop({ type: "int", default: 1024, description: "Height of output image", min: 256, max: 1024 })
  declare height: any;
  ...
  @prop({ type: "float", default: 2, description: "Guidance scale for input image. Higher values increase consistency with input image", min: 1, max: 3 })
  declare image_guidance_scale: any;

  @prop({ type: "int", default: 2048, description: "Maximum input image side length", min: 256, max: 2048 })
  declare max_input_image_side_length: any;

  @prop({ type: "int", default: 1048576, description: "Maximum number of pixels in output", min: 65536, max: 2359296 })
  ...
  @prop({ type: "int", default: 50, description: "Number of denoising steps", min: 20, max: 100 })
  declare num_inference_steps: any;
  ...
  @prop({ type: "float", default: 5, description: "Guidance scale for text prompt", min: 1, max: 8 })
  declare text_guidance_scale: any;

  @prop({ type: "int", default: 1024, description: "Width of output image", min: 256, max: 1024 })
  declare width: any;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const maxInputImageSideLength = Number(this.max_input_image_side_length ?? 2048);
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 80, description: "Output quality (for jpg and webp)", min: 1, max: 100 })
  declare output_quality: any;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const imgCondPathRef = this.img_cond_path as Record<string, unknown> | undefined;
...
replicate, ai`;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const aspectRatio = String(this.aspect_ratio ?? "16:9");
    const prompt = String(this.prompt ?? "");
    const referenceTags = this.reference_tags ?? [];
    ...
    const referenceImagesRefs = Array.isArray(this.reference_images) ? this.reference_images : [];
    const referenceImagesUrls: string[] = [];
    for (const ref of referenceImagesRefs) {
      if (isRefSet(ref)) {
        const url = await assetToUrl(ref as Record<string, unknown>, apiKey);
        if (url) referenceImagesUrls.push(url);
      }
    }
    if (referenceImagesUrls.length) args["reference_images"] = referenceImagesUrls;
    removeNulls(args);
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 2, description: "Classifier-Free Guidance scale - higher values encourage adherence to prompt, lower values encourage more creative interpretation", min: 1, max: 32 })
  declare cfg: any;
  ...
  @prop({ type: "float", default: 0.5, description: "Controls the amount of denoising applied when refining the high resolution output (higher = more adherence to the upscaled latent, lower = more creative details added)", min: 0.1, max: 1 })
  declare highres_denoise: any;

  @prop({ type: "float", default: 1.5, description: "The multiplier for the final output resolution relative to the initial latent resolution", min: 1, max: 3 })
  ...
  @prop({ type: "int", default: 1, description: "The number of unique images to generate from the given input and settings", min: 1, max: 12 })
  declare number_of_images: any;

  @prop({ type: "enum", default: "webp", values: ["webp", "jpg", "png"], description: "The image file format of the generated output images" })
  declare output_format: any;

  @prop({ type: "int", default: 80, description: "The image compression quality (for lossy formats like JPEG and WebP). 100 = best quality, 0 = lowest quality.", min: 0, max: 100 })
  declare output_quality: any;
  ...
  @prop({ type: "int", default: 25, description: "The number of diffusion steps to perform during generation (more steps generally improves image quality but increases processing time)", min: 1, max: 100 })
  declare steps: any;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const negativePrompt = String(this.negative_prompt ?? "lowres, bad anatomy, bad hands, cropped, worst quality");
    const numberOfImages = Number(this.number_of_images ?? 1);
    const outputFormat = String(this.output_format ?? "webp");
    const outputQuality = Number(this.output_quality ?? 80);
    const prompt = String(this.prompt ?? "");
    ...
    const backgroundImageRef = this.background_image as Record<string, unknown> | undefined;
    ...
    const subjectImageRef = this.subject_image as Record<string, unknown> | undefined;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 80, description: "Compression quality for JPEG / WebP (1-100)", min: 1, max: 100 })
  declare output_quality: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 1, description: "Strength of the color transfer effect (0.0 to 1.0)", min: 0, max: 1 })
  declare strength: any;

  @prop({ type: "float", default: 95, description: "Percentile for white balance calculation (0.0 to 100.0)", min: 0, max: 100 })
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 32, description: "Number of inference steps", min: 1, max: 100 })
  declare num_inference_steps: any;
  ...
  @prop({ type: "float", default: 0.5, description: "Strength of the diffusion", min: 0.1, max: 2 })
  declare strength: any;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 30, description: "Number of denoising steps", min: 1, max: 200 })
  declare num_inference_steps: any;
  ...
  async process(): Promise<Record<string, unknown>> {
    ...
    const height = Number(this.height ?? 1024);
    const negativePrompt = String(this.negative_prompt ?? "monochrome, lowres, bad anatomy, worst quality, low quality, blurry");
    const numInferenceSteps = Number(this.num_inference_steps ?? 30);
    const numOutputs = Number(this.num_outputs ?? 1);
    const prompt = String(this.prompt ?? "photo of a woman in red dress in a garden");
    const seed = Number(this.seed ?? -1);
    const width = Number(this.width ?? 1024);
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 30, description: "Number of denoising steps", min: 1, max: 500 })
  declare num_inference_steps: any;
  ...
  @prop({ type: "float", default: 0.6, description: "Scale (influence of input image on generation)", min: 0, max: 1 })
  declare scale: any;
