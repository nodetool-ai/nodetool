...
replicate, ai`;
  ...
  @prop({ type: "int", default: 1, description: "Batch size", min: 1 })
  declare batch_size: any;

  @prop({ type: "int", default: 8, description: "fps for the output video" })
  declare fps: any;

  @prop({ type: "float", default: 7.5, description: "Guidance scale", min: 1, max: 100 })
  declare guidance_scale: any;

  @prop({ type: "int", default: 320, description: "Height of the output video", min: 256 })
  declare height: any;
  ...
  @prop({ type: "int", default: 576, description: "Width of the output video", min: 256 })
  declare width: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 6, description: "Guidance scale", min: 1, max: 10 })
  declare embedded_guidance_scale: any;

  @prop({ type: "int", default: 24, description: "Frames per second of the output video", min: 1 })
  declare fps: any;

  @prop({ type: "int", default: 480, description: "Height of the video in pixels (must be divisible by 16)", min: 16, max: 1280 })
  declare height: any;

  @prop({ type: "int", default: 50, description: "Number of denoising steps", min: 1 })
  ...
  @prop({ type: "int", default: 129, description: "Number of frames to generate (must be 4k+1, ex: 49 or 129)", min: 1, max: 200 })
  declare video_length: any;

  @prop({ type: "int", default: 864, description: "Width of the video in pixels (must be divisible by 16)", min: 16, max: 1280 })
  declare width: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 3, description: "How strongly the video follows the prompt", min: 1, max: 20 })
  declare cfg: any;

  @prop({ type: "image", default: "", description: "Optional input image to use as the starting frame" })
  declare image: any;

  @prop({ type: "float", default: 0.15, description: "Lower numbers stick more closely to the input image", min: 0, max: 1 })
  ...
  @prop({ type: "int", default: 30, description: "Number of steps", min: 1, max: 50 })
  declare steps: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 1, description: "Determines how strongly the main LoRA should be applied. Sane results between 0 and 1 for base inference. You may still need to experiment to find the best value for your particular lora.", min: 0, max: 4 })
  ...
  @prop({ type: "float", default: 5, description: "Guidance scale for generation", min: 1, max: 10 })
  declare sample_guide_scale: any;

  @prop({ type: "int", default: 3, description: "Flow shift parameter for video generation", min: 0, max: 10 })
  declare sample_shift: any;

  @prop({ type: "int", default: 30, description: "Number of inference steps", min: 1, max: 40 })
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 6, description: "Classifier free guidance scale (higher values strengthen prompt adherence)", min: 0, max: 20 })
  declare sample_guide_scale: any;

  @prop({ type: "float", default: 8, description: "Sampling shift factor for flow matching (recommended range: 8-12)", min: 0, max: 20 })
  declare sample_shift: any;

  @prop({ type: "int", default: 30, description: "Number of sampling steps (higher = better quality but slower)", min: 10, max: 50 })
  declare sample_steps: any;
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 1, description: "Speech rate (only used if using text and not audio)", min: 0.8, max: 2 })
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.5, description: "How expressive lipsync can be (0-1)", min: 0, max: 1 })
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 16, description: "Frames per second. Note that the pricing of this model is based on the video duration at 16 fps", min: 5, max: 30 })
  ...
  @prop({ type: "int", default: 81, description: "Number of video frames. 81 frames give the best results", min: 81, max: 121 })
  declare num_frames: any;
  ...
  @prop({ type: "float", default: 12, description: "Sample shift factor", min: 1, max: 20 })
  declare sample_shift: any;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 5, description: "Video duration in seconds.", min: 3, max: 15 })
  declare duration: any;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 5, description: "Video duration in seconds (3-15). Ignored for video editing (base).", min: 3, max: 15 })
  declare duration: any;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 5, description: "Video duration in seconds", min: 2, max: 12 })
  declare duration: any;
