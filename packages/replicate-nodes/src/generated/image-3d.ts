...
replicate, ai`;
  ...
  @prop({ type: "float", default: 0.95, description: "GLB Extraction - Mesh Simplification (only used if generate_model=True)", min: 0.9, max: 0.98 })
  ...
  @prop({ type: "float", default: 3, description: "Stage 2: Structured Latent Generation - Guidance Strength", min: 0, max: 10 })
  declare slat_guidance_strength: any;

  @prop({ type: "int", default: 12, description: "Stage 2: Structured Latent Generation - Sampling Steps", min: 1, max: 50 })
  declare slat_sampling_steps: any;

  @prop({ type: "float", default: 7.5, description: "Stage 1: Sparse Structure Generation - Guidance Strength", min: 0, max: 10 })
  declare ss_guidance_strength: any;

  @prop({ type: "int", default: 12, description: "Stage 1: Sparse Structure Generation - Sampling Steps", min: 1, max: 50 })
  declare ss_sampling_steps: any;

  @prop({ type: "int", default: 1024, description: "GLB Extraction - Texture Size (only used if generate_model=True)", min: 512, max: 2048 })
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 5.5, description: "Guidance scale for generation", min: 1, max: 20 })
  declare guidance_scale: any;
  ...
  @prop({ type: "int", default: 50, description: "Number of inference steps", min: 20, max: 50 })
  declare steps: any;
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 200000, description: "Number of chunks", min: 1000, max: 5000000 })
  declare num_chunks: any;

  @prop({ type: "int", default: 256, description: "Octree resolution", min: 16, max: 512 })
  declare octree_resolution: any;
  ...
  @prop({ type: "int", default: 30, description: "Number of inference steps", min: 1, max: 100 })
  declare steps: any;

  @prop({ type: "int", default: 10000, description: "Target number of faces for mesh simplification", min: 100, max: 1000000 })
...
replicate, ai`;
  ...
  @prop({ type: "float", default: 1, description: "Classifier-free guidance scale (higher = stronger restoration).", min: 0, max: 15 })
  declare cfg_scale: any;

  @prop({ type: "int", default: 24, description: "Frames-per-second for video outputs.", min: 1, max: 120 })
  declare fps: any;
  ...
  @prop({ type: "int", default: 90, description: "Image quality for lossy formats (jpg/webp).", min: 10, max: 100 })
  declare output_quality: any;

  @prop({ type: "int", default: 1, description: "Sampling steps (1 = fast one-step mode).", min: 1, max: 4 })
  declare sample_steps: any;

  @prop({ type: "int", default: -1, description: "Random seed. Leave blank for a random seed each call." })
  declare seed: any;

  @prop({ type: "int", default: 1, description: "Sequence-parallel shard heuristic (single-GPU build only accepts 1).", min: 1, max: 4 })
  declare sp_size: any;
