...
replicate, ai`;
  ...
  @prop({ type: "float", default: 1, description: "Guidance scale", min: 0, max: 10 })
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 0, description: "Pose style", min: 0, max: 45 })
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 81, description: "Number of frames to generate (automatically adjusted to nearest valid value of form 4n+1, e.g., 81, 181)", min: 25, max: 201 })
  ...
  @prop({ type: "int", default: 40, description: "Number of sampling steps (higher = better quality, lower = faster)", min: 2, max: 100 })
...
replicate, ai`;
  ...
  @prop({ type: "int", default: 80, description: "Quality of the output images, from 0 to 100. 100 is best quality, 1 is lowest quality.", min: 1, max: 100 })
