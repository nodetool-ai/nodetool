...
describe('highlightText utilities', () => {
  ...
  describe('formatBulletList', () => {
    ...
    it('handles single line without newlines', () => {
      expect(formatBulletList('single item')).toBe('<ul><li>single item</li></ul>');
    });
  ...
  describe('highlightText', () => {
    ...
    describe('highlighting matches', () => {
      ...
      it('highlights multiple matches', () => {
        const searchInfo: NodeMetadata['searchInfo'] = {
          matches: [
            { key: 'title', value: 'hello world hello', indices: [[0, 4], [12, 16]] }
          ]
        };
        const result = highlightText('hello world hello', 'title', 'hello', searchInfo);
      ...
      it('handles matches at the end of string', () => {
        const searchInfo: NodeMetadata['searchInfo'] = {
          matches: [
            { key: 'title', value: 'hello test', indices: [[6, 9]] }
          ]
        };
      ...
      it('handles matches with different relevance scores', () => {
        const searchInfo: NodeMetadata['searchInfo'] = {
          matches: [
            { key: 'title', value: 'test testing', indices: [[0, 3], [5, 11]] }
          ]
        };
        const result = highlightText('test testing', 'title', 'test', searchInfo);
      ...
      it('escapes HTML in matched text', () => {
        ...
        const result = highlightText('<script>alert</script>', 'title', '<script>', searchInfo);
      ...
      it('handles very long text with many matches efficiently', () => {
        ...
        const searchInfo: NodeMetadata['searchInfo'] = {
          matches: [
            { key: 'title', value: longText, indices }
          ]
        };
      ...
      it('handles bullet list with highlights', () => {
        ...
        const result = highlightText('hello\nworld', 'title', 'hello', searchInfo, true);
