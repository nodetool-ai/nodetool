...
describe("highlightText utilities", () => {
  ...
  describe("highlightText", () => {
    type SearchInfoMatch = { key: string; value: string; indices: number[][] };
    type SearchInfo = { score?: number; matches?: SearchInfoMatch[] };
    
    const createSearchInfo = (matches: SearchInfoMatch[]): SearchInfo => {
      return {
        matches,
        score: 1
      };
