...
const PERF_THRESHOLD_SMALL = 80; // 80ms for small dataset (increased for CI stability)
const PERF_THRESHOLD_MEDIUM = 180; // 180ms for medium dataset (increased for CI stability)
