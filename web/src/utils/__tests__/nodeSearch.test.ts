...
const PERF_THRESHOLD_SMALL = 150; // 150ms for small dataset
const PERF_THRESHOLD_MEDIUM = 200; // 200ms for medium dataset
const PERF_THRESHOLD_LARGE = 300; // 300ms for large dataset
