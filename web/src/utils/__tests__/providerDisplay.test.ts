...
describe("providerDisplay", () => {
  ...
  describe("getProviderBaseName", () => {
    it("should extract base name from HuggingFace providers", () => {
      expect(getProviderBaseName("huggingface/fireworks-ai")).toBe(
        "Fireworks Ai"
      );
      ...
      expect(getProviderBaseName("HuggingFaceBlackForestLabs")).toBe(
        "Black Forest Labs"
      );
    });
    ...
    it("should normalize separators", () => {
      expect(getProviderBaseName("test-provider_name")).toBe(
        "Test Provider Name"
      );
      expect(getProviderBaseName("test--provider__name")).toBe(
        "Test Provider Name"
      );
    });
    ...
    it("should add spaces before capitals", () => {
      ...
      expect(getProviderBaseName("testProviderName")).toBe(
        "Test Provider Name"
      );
  ...
  describe("formatGenericProviderName", () => {
    ...
    it("should handle other provider aliases", () => {
      ...
      expect(formatGenericProviderName("meta")).toBe("Meta AI");
    ...
    it("should add spaces before capitals", () => {
      expect(formatGenericProviderName("OpenAI")).toBe("OpenAI");
      expect(formatGenericProviderName("BlackForestLabs")).toBe(
        "Black Forest Labs"
      );
      expect(formatGenericProviderName("testProviderName")).toBe(
        "Test Provider Name"
      );
    });
    ...
    it("should normalize multiple separators", () => {
      expect(formatGenericProviderName("test___provider---name")).toBe(
        "Test Provider Name"
      );
    });
  });
  ...
  describe("getProviderUrl", () => {
    it("should return HuggingFace URLs for HF providers", () => {
      ...
      expect(getProviderUrl("huggingface/fireworks-ai")).toBe(
        "https://huggingface.co/fireworks-ai"
      );
      expect(getProviderUrl("huggingface_cerebras")).toBe(
        "https://huggingface.co/cerebras"
      );
      expect(getProviderUrl("HuggingFaceBlackForestLabs")).toBe(
        "https://huggingface.co/blackforestlabs"
      );
    });

    it("should handle HuggingFace org aliases", () => {
      expect(getProviderUrl("huggingface/together")).toBe(
        "https://huggingface.co/togethercomputer"
      );
      expect(getProviderUrl("huggingface_sambanova")).toBe(
        "https://huggingface.co/sambanovasystems"
      );
    });
    ...
    it("should return URLs for known providers", () => {
      ...
      expect(getProviderUrl("point_e")).toBe(
        "https://github.com/openai/point-e"
      );
      expect(getProviderUrl("hunyuan3d")).toBe(
    ...
    it("should return URLs for additional known providers", () => {
      ...
      expect(getProviderUrl("llama_cpp")).toBe(
        "https://github.com/ggerganov/llama.cpp"
      );
      expect(getProviderUrl("llama-cpp")).toBe(
        "https://github.com/ggerganov/llama.cpp"
      );
      expect(getProviderUrl("minimax")).toBe("https://platform.minimax.io");
      expect(getProviderUrl("gmi")).toBe("https://www.gmicloud.ai");
      expect(getProviderUrl("meta")).toBe("https://dev.meta.ai");
    ...
    it("should handle partial matches", () => {
      ...
      expect(getProviderUrl("openai-custom")).toBe(
        "https://platform.openai.com"
      );
      expect(getProviderUrl("anthropic-claude")).toBe(
        "https://console.anthropic.com"
      );
    });

    it("should handle complex HuggingFace paths", () => {
      expect(getProviderUrl("huggingface/org/sub/path")).toBe(
    ...
    it("should normalize HuggingFace slugs", () => {
      expect(getProviderUrl("huggingface/Test Provider")).toBe(
        "https://huggingface.co/test-provider"
      );
      expect(getProviderUrl("huggingface_test_provider")).toBe(
        "https://huggingface.co/test-provider"
      );
  ...
  describe("isLocalProvider", () => {
    ...
    it("returns false for cloud providers", () => {
      ...
      expect(isLocalProvider("huggingface")).toBe(false);
    });
  ...
  describe("getModelUrl", () => {
    ...
    it("returns HuggingFace URL for HF provider", () => {
      expect(getModelUrl("huggingface", "user/repo")).toBe(
        "https://huggingface.co/user/repo"
      );
      expect(getModelUrl("huggingface-local", "user/repo")).toBe(
        "https://huggingface.co/user/repo"
      );
    });

    it("returns Ollama library URL for Ollama models", () => {
      expect(getModelUrl("ollama", "gemma:2b")).toBe(
    ...
    it("returns Google docs URL", () => {
      expect(getModelUrl("gemini", "gemini-pro")).toBe(
    ...
    it("infers Ollama from model ID with colon", () => {
      expect(getModelUrl("", "llama3:latest")).toBe(
        "https://ollama.com/library/llama3"
      );
    });

    it("infers HuggingFace as default", () => {
      expect(getModelUrl("", "user/model")).toBe(
        "https://huggingface.co/user/model"
      );
    });

    it("uses modelType hint for llama_model", () => {
      expect(getModelUrl("", "some-model", "llama_model")).toBe(
        "https://ollama.com/library/some-model"
      );
    });
    ...
    it("returns HuggingFace URL for HF sub-providers", () => {
      expect(getModelUrl("hf_inference", "user/repo")).toBe(
        "https://huggingface.co/user/repo"
      );
      expect(getModelUrl("huggingface_cerebras", "user/repo")).toBe(
        "https://huggingface.co/user/repo"
      );
    });
