 ...
 * (model, provider, settings) and how it was wired into the graph — while
 * never leaking secrets (API keys, tokens) or dumping megabytes of inlined
 * media into a public GitHub issue.
 */
