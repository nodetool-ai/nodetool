...
export function uint8ArrayToBase64(uint8Array: Uint8Array): string {
    try {
        ...
        const binaryString = numberArray.reduce((str, byte) => str + String.fromCharCode(byte), '');
 ...
 */
export function uint8ArrayToDataUri(uint8Array: Uint8Array, mimeType: string): string {
    try {
