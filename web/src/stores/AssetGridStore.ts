...
export const useAssetGridStore = create<AssetGridState>((set, get) => ({
    ...
    setCurrentFolder: (folder) => set({ currentFolder: folder, currentFolderId: folder?.id }),
    setCurrentFolderId: (folderId) => set({ currentFolderId: folderId, currentFolder: null, parentFolder: null }),
