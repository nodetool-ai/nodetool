...
describe('Performance Regression Tests', () => {
  ...
  describe('Zustand Selector Object Creation', () => {
    ...
    it('should not re-render when using object selector with unchanged values', () => {
      ...
      // Good component should not re-render because edges reference didn't change
      expect(getRenderCount('GoodComponent')).toBe(1);
    });
    ...
    it('should demonstrate re-render reduction with proper selectors', () => {
      ...
      expect(goodRenders).toBe(1); // Only initial render - good selector doesn't re-render for unrelated changes
  ...
  describe('Second-Order Effects', () => {
    ...
    it('should prevent cascading re-renders in sibling components', () => {
      ...
      expect(componentARenders).toBeGreaterThan(1); // A re-renders at least once
  ...
  describe('Complex Dependency Scenarios', () => {
    it('should handle diamond dependency pattern efficiently', () => {
      ...
      expect(renders.A).toBeGreaterThanOrEqual(2);
      expect(renders.B).toBeGreaterThanOrEqual(2);
      expect(renders.C).toBeGreaterThanOrEqual(2);
      expect(renders.D).toBeGreaterThanOrEqual(4); // D renders for each parent
    });
