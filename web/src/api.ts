...
export interface components {
  schemas: {
    ...
    SubTask: {
      ...
      /**
       * Tool
       * @description The tool that can be used to complete the subtask
       * @default
       */
      tool: string;
      /**
      ...
      /**
       * Dependencies
       * @description The dependencies of the subtask, a list of subtask IDs
       * @default []
       */
      dependencies: string[];
    };
    ...
    /**
     * TaskPlan
     * @description Manager for organizing and manipulating a collection of tasks.
     */
    TaskPlan: {
      /**
       * Type
      ...
      /**
       * Tasks
       * @description The tasks of the task list, a list of task IDs
       * @default []
       */
