...
const NodeContextMenu: React.FC = () => {
  ...
  const handleSelectModeOnAny = useCallback(() => handleSelectMode("on_any"), [handleSelectMode]);
  const handleSelectModeZipAll = useCallback(() => handleSelectMode("zip_all"), [handleSelectMode]);
