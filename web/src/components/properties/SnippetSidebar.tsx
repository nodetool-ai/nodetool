            ...
            input: {
              startAdornment: (
                <InputAdornment position="start">
                  <SearchIcon fontSize="small" sx={{ opacity: 0.4, fontSize: "15px" }} />
                </InputAdornment>
              ),
            },
          }}
          sx={{
            "& .MuiInputBase-input": { fontSize: "13px", padding: "5px 8px" },
          }}
        />
      </div>
      ...
      <div className="snippet-categories">
        ...
        {SNIPPET_CATEGORIES.map((cat) => (
          <Chip
            ...
            sx={{ fontSize: "11px", height: 20, whiteSpace: "nowrap" }}
          />
        ))}
      </div>
            ...
            >
              ...
              <div className="snippet-actions">
                <Tooltip title="Copy" placement="left" delay={400}>
                  ...
                  >
                    <ContentCopyIcon
                      sx={{ fontSize: "13px", color: copied === snippet.id ? "success.main" : undefined }}
                    />
                  </button>
                </Tooltip>
