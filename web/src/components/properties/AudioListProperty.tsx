...
const styles = (theme: Theme) =>
  css({
    ...
    ".audio-item": {
      position: "relative",
      width: "100%",
      backgroundColor: alpha(theme.vars.palette.grey[900] || "#000000", 0.2),
      borderRadius: "6px",
      overflow: "hidden",
    ...
    ".remove-button": {
      ...
      backgroundColor: alpha(theme.vars.palette.grey[900] || "#000000", 0.7),
    ...
    ".dropzone": {
      ...
      "&:hover": {
        ...
        backgroundColor: alpha(theme.vars.palette.grey[900] || "#000000", 0.3)
      },
      "&.drag-over": {
