...
Palette formats — Affinity supports importing .ase (Adobe Swatch Exchange) and .aco palette files, plus its own .afpalette format. So migrating from Adobe workflows is straightforward. You can also export your palettes in these formats.
