            ...
            <div className="settings-content">
              ...
              <div className="settings-section">
                ...
                <div className="settings-item">
                  ...
                  <div className="text-and-button">
                    <Typography className="description">
                      Setting up an OpenAI API key enables you to use models
                      like GPT, Whisper, DALL-E, and more.
                      <br />
                      <a
                ...
                <div className="settings-item">
                  ...
                  <div className="text-and-button">
                    <Typography className="description">
                      By entering your Anthropic API token, you&apos;ll be able
                      to use sophisticated models like Claude 3.5 Sonnet. models
                ...
                <div className="settings-item">
                  ...
                  <div className="text-and-button">
                    <Typography className="description">
                      ...
                      capabilities.
                      <br /> By configuring your Replicate API token,
                      you&apos;ll gain access to models like flux.dev and
                      flux.pro.
                      <br />
                      <a
                ...
                <div className="settings-item">
                  ...
                  <div className="text-and-button">
                    <Typography className="description">
                      Enter your HuggingFace Access Token to use additional
                      models that are not openly available.
                      <br />
                      <a
                ...
                <div className="settings-item">
                  ...
                  <TextField
                    ...
                    onChange={(e) =>
                      handleChange("AIME_API_KEY", e.target.value)
                    }
                    variant="standard"
                    sx={{ marginTop: "1em" }}
                  />
                ...
                <div className="settings-item">
                  <TextField
                    ...
                    onChange={(e) =>
                      handleChange("FAL_API_KEY", e.target.value)
                    }
                    variant="standard"
                  />
                  <div className="text-and-button">
              ...
              <div className="settings-item">
                ...
                <div className="text-and-button">
                  <Typography className="description">
                    ...
                    <br />• <strong>API Key</strong>: Your authentication key
                    for Brightdata services
              ...
              <div className="settings-section">
                ...
                <div className="settings-item folder-path">
                  <TextField
                    ...
                    onChange={(e) =>
                      handleChange("COMFY_FOLDER", e.target.value)
                    }
                    variant="standard"
                    placeholder="PATH/TO/ComfyUI"
                  />
                  <Typography className="description">
                    To use ComfyUI models from your existing ComfyUI
                    installation, set the path to your ComfyUI folder.
                  </Typography>
                </div>
                ...
                <div className="settings-item">
                  <TextField
                    ...
                    onChange={(e) =>
                      handleChange("CHROMA_PATH", e.target.value)
                    }
                    variant="standard"
                  />
                  <Typography className="description">
                    ChromaDB is used to store and retrieve embeddings for
                    semantic search.
                    <br />
                    Set the path where you want ChromaDB to store its data.
                    <br />
                    This can be any folder path - ChromaDB will create and
                    manage the storage automatically.
                    <br />
                  </Typography>
                </div>
              </div>
