...
interface AssetRefGridContentProps {
  itemSpacing?: number;
  assetRefs?: AssetRef[];
...
const AssetRefGridContent: React.FC<AssetRefGridContentProps> = ({
  itemSpacing = 2,
  assetRefs = [],
  isHorizontal,
  onDoubleClick
  ...
  const preparedItems = useMemo(() => {
    return prepareItems(assetRefs || [], expandedTypes);
  }, [assetRefs, expandedTypes]);
...
export default AssetRefGridContent;
