...
const QUICK_ACTION_BUTTONS: QuickActionDefinition[] = [
  ...
  },
  {
    ...
    gradient:
      "linear-gradient(135deg, rgba(245, 158, 11, 0.45), rgba(16, 185, 129, 0.32))",
    hoverGradient:
      "linear-gradient(135deg, rgba(251, 191, 36, 0.55), rgba(52, 211, 153, 0.42))",
    shadow: "0 6px 16px rgba(245, 158, 11, 0.28)",
    hoverShadow:
      "0 10px 26px rgba(16, 185, 129, 0.38), 0 0 20px rgba(245, 158, 11, 0.24)",
    iconColor: "#fffbeb"
  },
  {
    key: "text-to-speech",
