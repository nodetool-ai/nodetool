export default {
  ...
  moduleNameMapper: {
    ...
    "^.*components/node/ImageView$": "<rootDir>/src/__mocks__/emptyModule.ts",
    "^.*components/chat/message/MessageContentRenderer$": "<rootDir>/src/__mocks__/emptyModule.ts",
    "^.*components/chat/message/MessageView$": "<rootDir>/src/__mocks__/emptyModule.ts",
    "^.*components/chat/thread/ChatThreadView$": "<rootDir>/src/__mocks__/emptyModule.ts",
    "^.*components/chat/containers/ChatView$": "<rootDir>/src/__mocks__/emptyModule.ts",
    "^.*components/properties/TextEditorModal$": "<rootDir>/src/__mocks__/emptyModule.ts",
    "^.*components/properties/StringProperty$": "<rootDir>/src/__mocks__/emptyModule.ts",
    "^.*components/node/PropertyInput$": "<rootDir>/src/__mocks__/emptyModule.ts",
    "^.*components/node/PropertyField$": "<rootDir>/src/__mocks__/emptyModule.ts",
    "^.*components/node/NodeInputs$": "<rootDir>/src/__mocks__/emptyModule.ts",
    "^.*components/node_types/PlaceholderNode$": "<rootDir>/src/__mocks__/emptyModule.ts"
  },
