...
from genflow.metadata.types import CLIP, Conditioning
...
class CLIPTextEncodeSDXL(ComfyNode):
    ...
    target_width: int = Field(default=1024, le=2048, description="The target width to use.")
    target_height: int = Field(default=1024, le=2048, description="The target height to use.")
    text_g: str = Field(
        default="CLIP_G",
