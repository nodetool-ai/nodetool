...
class IPAdapterApply(GraphNode):
    ipadapter: IPAdapter | GraphNode | tuple[GraphNode, str] = Field(default=IPAdapter(type='comfy.ip_adapter', name=''), description='The IPAdapter to apply.')
    clip_vision: CLIPVision | GraphNode | tuple[GraphNode, str] = Field(default=CLIPVision(type='comfy.clip_vision', name=''), description='The CLIP vision to use.')
    ...
    model: UNet | GraphNode | tuple[GraphNode, str] = Field(default=UNet(type='comfy.unet', name=''), description='The model to apply the IPAdapter to.')
...
class IPAdapterApplyFaceID(GraphNode):
    ipadapter: IPAdapter | GraphNode | tuple[GraphNode, str] = Field(default=IPAdapter(type='comfy.ip_adapter', name=''), description='The IPAdapter.')
    clip_vision: CLIPVision | GraphNode | tuple[GraphNode, str] = Field(default=CLIPVision(type='comfy.clip_vision', name=''), description='The CLIP vision.')
    insightface: InsightFace | GraphNode | tuple[GraphNode, str] = Field(default=InsightFace(type='comfy.insight_face', data=None), description='The InsightFace.')
    image: ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=ImageRef(type='image', uri='', asset_id=None, data=None), description='The image to use.')
    model: UNet | GraphNode | tuple[GraphNode, str] = Field(default=UNet(type='comfy.unet', name=''), description='The model to apply the IPAdapter.')
