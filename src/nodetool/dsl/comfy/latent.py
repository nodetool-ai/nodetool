...
class VAEDecode(GraphNode):
    ...
    vae: VAE | GraphNode | tuple[GraphNode, str] = Field(default=VAE(type='comfy.vae', name=''), description='The VAE to use.')
    @classmethod
...
class VAEDecodeTiled(GraphNode):
    samples: Latent | GraphNode | tuple[GraphNode, str] = Field(default=Latent(type='comfy.latent', data=None), description='The latent samples to decode.')
    vae: VAE | GraphNode | tuple[GraphNode, str] = Field(default=VAE(type='comfy.vae', name=''), description='The VAE to use for decoding.')
...
class VAEEncodeForInpaint(GraphNode):
    ...
    vae: VAE | GraphNode | tuple[GraphNode, str] = Field(default=VAE(type='comfy.vae', name=''), description='The VAE to use for encoding.')
