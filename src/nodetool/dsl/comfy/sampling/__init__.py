...
class KSampler(GraphNode):
    ...
    SeedControlMode: typing.ClassVar[type] = nodetool.nodes.comfy.sampling.KSampler.SeedControlMode
    SamplerEnum: typing.ClassVar[type] = nodetool.nodes.comfy.sampling.KSampler.SamplerEnum
    SchedulerEnum: typing.ClassVar[type] = nodetool.nodes.comfy.sampling.KSampler.SchedulerEnum
    ...
    seed_control_mode: nodetool.nodes.comfy.sampling.KSampler.SeedControlMode = Field(default=SeedControlMode.FIXED, description='The seed control mode to use.')
    ...
    sampler_name: nodetool.nodes.comfy.sampling.KSampler.SamplerEnum = Field(default=SamplerEnum.DDIM, description='The sampler to use.')
    scheduler: nodetool.nodes.comfy.sampling.KSampler.SchedulerEnum = Field(default=SchedulerEnum.NORMAL, description='The scheduler to use.')
...
class KSamplerAdvanced(GraphNode):
    ...
    EnableDisable: typing.ClassVar[type] = nodetool.nodes.comfy.comfy_node.KSamplerAdvanced.EnableDisable
    SamplerEnum: typing.ClassVar[type] = nodetool.nodes.comfy.sampling.KSamplerAdvanced.SamplerEnum
    SchedulerEnum: typing.ClassVar[type] = nodetool.nodes.comfy.sampling.KSamplerAdvanced.SchedulerEnum
    EnableDisable: typing.ClassVar[type] = nodetool.nodes.comfy.comfy_node.KSamplerAdvanced.EnableDisable
    model: UNet | GraphNode | tuple[GraphNode, str] = Field(default=UNet(type='comfy.unet', name='', model=None), description='The model to use.')
    add_noise: nodetool.nodes.comfy.comfy_node.KSamplerAdvanced.EnableDisable = Field(default=EnableDisable.ENABLE, description='Enable or disable noise addition.')
    ...
    sampler_name: nodetool.nodes.comfy.sampling.KSamplerAdvanced.SamplerEnum = Field(default=SamplerEnum.DDIM, description='The name of the sampler to use.')
    scheduler: nodetool.nodes.comfy.sampling.KSamplerAdvanced.SchedulerEnum = Field(default=SchedulerEnum.NORMAL, description='The scheduler to use.')
    ...
    return_with_leftover_noise: nodetool.nodes.comfy.comfy_node.KSamplerAdvanced.EnableDisable = Field(default=EnableDisable.DISABLE, description='Whether to return with leftover noise or not.')
