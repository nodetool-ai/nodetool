...
class HotshotXL(GraphNode):
    ...
    width: nodetool.nodes.replicate.video.generate.HotshotXL.Width = Field(default=nodetool.nodes.replicate.video.generate.HotshotXL.Width(672), description='Width of the output')
    height: nodetool.nodes.replicate.video.generate.HotshotXL.Height = Field(default=nodetool.nodes.replicate.video.generate.HotshotXL.Height(384), description='Height of the output')
...
class LTX_Video(GraphNode):
    ...
    model: nodetool.nodes.replicate.video.generate.LTX_Video.Model = Field(default=nodetool.nodes.replicate.video.generate.LTX_Video.Model('0.9.1'), description='Model version to use')
    steps: int | GraphNode | tuple[GraphNode, str] = Field(default=30, description='Number of steps')
    length: nodetool.nodes.replicate.video.generate.LTX_Video.Length = Field(default=nodetool.nodes.replicate.video.generate.LTX_Video.Length(97), description='Length of the output video in frames')
    ...
    target_size: nodetool.nodes.replicate.video.generate.LTX_Video.Target_size = Field(default=nodetool.nodes.replicate.video.generate.LTX_Video.Target_size(640), description='Target size for the output video')
    aspect_ratio: nodetool.nodes.replicate.video.generate.LTX_Video.Aspect_ratio = Field(default=nodetool.nodes.replicate.video.generate.LTX_Video.Aspect_ratio('3:2'), description='Aspect ratio of the output video. Ignored if an image is provided.')
...
class Music_01(GraphNode):
    ...
    bitrate: nodetool.nodes.replicate.video.generate.Music_01.Bitrate = Field(default=nodetool.nodes.replicate.video.generate.Music_01.Bitrate(256000), description='Bitrate for the generated music')
    ...
    sample_rate: nodetool.nodes.replicate.video.generate.Music_01.Sample_rate = Field(default=nodetool.nodes.replicate.video.generate.Music_01.Sample_rate(44100), description='Sample rate for the generated music')
...
class Ray(GraphNode):
    ...
    aspect_ratio: nodetool.nodes.replicate.video.generate.Ray.Aspect_ratio = Field(default=nodetool.nodes.replicate.video.generate.Ray.Aspect_ratio('16:9'), description="Aspect ratio of the video (e.g. '16:9'). Ignored if a start or end frame or video ID is given.")
...
class RobustVideoMatting(GraphNode):
    ...
    output_type: nodetool.nodes.replicate.video.generate.RobustVideoMatting.Output_type = Field(default=nodetool.nodes.replicate.video.generate.RobustVideoMatting.Output_type('green-screen'), description=None)
