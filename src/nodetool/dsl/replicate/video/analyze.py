...
class VideoLlava(GraphNode):
    ...
    video_path: VideoRef | GraphNode | tuple[GraphNode, str] = Field(default=VideoRef(type='video', uri='', asset_id=None, duration=None, format=None, data=None), description='Path to video file.')
