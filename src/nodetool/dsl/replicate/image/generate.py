...
class AdInpaint(GraphNode):
    ...
    pixel: nodetool.nodes.replicate.image.generate.AdInpaint.Pixel = Field(default=nodetool.nodes.replicate.image.generate.AdInpaint.Pixel('512 * 512'), description='image total pixel')
...
class Flux_1_1_Pro_Ultra(GraphNode):
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_1_1_Pro_Ultra.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_1_1_Pro_Ultra.Aspect_ratio('1:1'), description='Aspect ratio for the generated image')
...
class Flux_360(GraphNode):
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_360.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_360.Megapixels('1'), description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_360.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_360.Aspect_ratio('1:1'), description='Aspect ratio for the generated image. If custom is selected, uses height and width below & will run in bf16 mode')
...
class Flux_Black_Light(GraphNode):
    ...
    extra_lora: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description="Load LoRA weights. Supports Replicate models in the format <owner>/<username> or <owner>/<username>/<version>, HuggingFace URLs in the format huggingface.co/<owner>/<model-name>, CivitAI URLs in the format civitai.com/models/<id>[/<model-name>], or arbitrary .safetensors URLs from the Internet. For example, 'fofr/flux-pixar-cars'")
    lora_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=1, description="Determines how strongly the main LoRA should be applied. Sane results between 0 and 1 for base inference. For go_fast we apply a 1.5x multiplier to this value; we've generally seen good performance when scaling the base value by that amount. You may still need to experiment to find the best value for your particular lora.")
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Black_Light.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Black_Light.Megapixels('1'), description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Black_Light.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Black_Light.Aspect_ratio('1:1'), description='Aspect ratio for the generated image. If custom is selected, uses height and width below & will run in bf16 mode')
...
class Flux_Canny_Dev(GraphNode):
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Canny_Dev.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Canny_Dev.Megapixels('1'), description='Approximate number of megapixels for generated image. Use match_input to match the size of the input (with an upper limit of 1440x1440 pixels)')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
...
class Flux_Cinestill(GraphNode):
    ...
    extra_lora: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description="Load LoRA weights. Supports Replicate models in the format <owner>/<username> or <owner>/<username>/<version>, HuggingFace URLs in the format huggingface.co/<owner>/<model-name>, CivitAI URLs in the format civitai.com/models/<id>[/<model-name>], or arbitrary .safetensors URLs from the Internet. For example, 'fofr/flux-pixar-cars'")
    lora_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=1, description="Determines how strongly the main LoRA should be applied. Sane results between 0 and 1 for base inference. For go_fast we apply a 1.5x multiplier to this value; we've generally seen good performance when scaling the base value by that amount. You may still need to experiment to find the best value for your particular lora.")
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Cinestill.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Cinestill.Megapixels('1'), description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Cinestill.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Cinestill.Aspect_ratio('1:1'), description='Aspect ratio for the generated image. If custom is selected, uses height and width below & will run in bf16 mode')
...
class Flux_Depth_Dev(GraphNode):
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Depth_Dev.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Depth_Dev.Megapixels('1'), description='Approximate number of megapixels for generated image. Use match_input to match the size of the input (with an upper limit of 1440x1440 pixels)')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
...
class Flux_Dev(GraphNode):
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Dev.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Dev.Megapixels('1'), description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Dev.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Dev.Aspect_ratio('1:1'), description='Aspect ratio for the generated image')
...
class Flux_Dev_Lora(GraphNode):
    ...
    guidance: float | GraphNode | tuple[GraphNode, str] = Field(default=3, description='Guidance for generated image')
    lora_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=1, description="Determines how strongly the main LoRA should be applied. Sane results between 0 and 1 for base inference. For go_fast we apply a 1.5x multiplier to this value; we've generally seen good performance when scaling the base value by that amount. You may still need to experiment to find the best value for your particular lora.")
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Dev_Lora.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Dev_Lora.Megapixels('1'), description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Dev_Lora.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Dev_Lora.Aspect_ratio('1:1'), description='Aspect ratio for the generated image')
...
class Flux_Mona_Lisa(GraphNode):
    ...
    extra_lora: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description="Load LoRA weights. Supports Replicate models in the format <owner>/<username> or <owner>/<username>/<version>, HuggingFace URLs in the format huggingface.co/<owner>/<model-name>, CivitAI URLs in the format civitai.com/models/<id>[/<model-name>], or arbitrary .safetensors URLs from the Internet. For example, 'fofr/flux-pixar-cars'")
    lora_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=1, description="Determines how strongly the main LoRA should be applied. Sane results between 0 and 1 for base inference. For go_fast we apply a 1.5x multiplier to this value; we've generally seen good performance when scaling the base value by that amount. You may still need to experiment to find the best value for your particular lora.")
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Mona_Lisa.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Mona_Lisa.Megapixels('1'), description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Mona_Lisa.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Mona_Lisa.Aspect_ratio('1:1'), description='Aspect ratio for the generated image. If custom is selected, uses height and width below & will run in bf16 mode')
...
class Flux_Pro(GraphNode):
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Pro.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Pro.Aspect_ratio('1:1'), description='Aspect ratio for the generated image')
    image_prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Image to use with Flux Redux. This is used together with the text prompt to guide the generation towards the composition of the image_prompt. Must be jpeg, png, gif, or webp.')
...
class Flux_Redux_Dev(GraphNode):
    ...
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Set for reproducible generation')
    guidance: float | GraphNode | tuple[GraphNode, str] = Field(default=3, description='Guidance for generated image')
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Redux_Dev.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Redux_Dev.Megapixels('1'), description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Redux_Dev.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Redux_Dev.Aspect_ratio('1:1'), description='Aspect ratio for the generated image')
...
class Flux_Redux_Schnell(GraphNode):
    ...
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Set for reproducible generation')
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Redux_Schnell.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Redux_Schnell.Megapixels('1'), description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    redux_image: ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=ImageRef(type='image', uri='', asset_id=None, data=None), description='Input image to condition your output on. This replaces prompt for FLUX.1 Redux models')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Redux_Schnell.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Redux_Schnell.Aspect_ratio('1:1'), description='Aspect ratio for the generated image')
...
class Flux_Schnell(GraphNode):
    ...
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Prompt for generated image')
    go_fast: bool | GraphNode | tuple[GraphNode, str] = Field(default=True, description='Run faster predictions with model optimized for speed (currently fp8 quantized); disable to run in original bf16')
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Schnell.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Schnell.Megapixels('1'), description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Schnell.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Schnell.Aspect_ratio('1:1'), description='Aspect ratio for the generated image')
...
class Flux_Schnell_Lora(GraphNode):
    ...
    go_fast: bool | GraphNode | tuple[GraphNode, str] = Field(default=True, description='Run faster predictions with model optimized for speed (currently fp8 quantized); disable to run in original bf16')
    lora_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=1, description="Determines how strongly the main LoRA should be applied. Sane results between 0 and 1 for base inference. For go_fast we apply a 1.5x multiplier to this value; we've generally seen good performance when scaling the base value by that amount. You may still need to experiment to find the best value for your particular lora.")
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Schnell_Lora.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Schnell_Lora.Megapixels('1'), description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Schnell_Lora.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Schnell_Lora.Aspect_ratio('1:1'), description='Aspect ratio for the generated image')
    lora_weights: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description="Load LoRA weights. Supports Replicate models in the format <owner>/<username> or <owner>/<username>/<version>, HuggingFace URLs in the format huggingface.co/<owner>/<model-name>, CivitAI URLs in the format civitai.com/models/<id>[/<model-name>], or arbitrary .safetensors URLs from the Internet. For example, 'fofr/flux-pixar-cars'")
...
class Hyper_Flux_8Step(GraphNode):
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.Hyper_Flux_8Step.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Hyper_Flux_8Step.Aspect_ratio('1:1'), description="Aspect ratio for the generated image. The size will always be 1 megapixel, i.e. 1024x1024 if aspect ratio is 1:1. To use arbitrary width and height, set aspect ratio to 'custom'.")
...
class Ideogram_V2(GraphNode):
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.Ideogram_V2.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Ideogram_V2.Aspect_ratio('1:1'), description='Aspect ratio. Ignored if a resolution or inpainting image is given.')
...
class Ideogram_V2_Turbo(GraphNode):
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.Ideogram_V2_Turbo.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Ideogram_V2_Turbo.Aspect_ratio('1:1'), description='Aspect ratio. Ignored if a resolution or inpainting image is given.')
    negative_prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Things you do not want to see in the generated image.')
...
class Illusions(GraphNode):
    ...
    sizing_strategy: nodetool.nodes.replicate.image.generate.Illusions.Sizing_strategy = Field(default=nodetool.nodes.replicate.image.generate.Illusions.Sizing_strategy('width/height'), description='Decide how to resize images – use width/height, resize based on input image or control image')
...
class Kandinsky(GraphNode):
    ...
    width: nodetool.nodes.replicate.image.generate.Kandinsky.Width = Field(default=nodetool.nodes.replicate.image.generate.Kandinsky.Width(512), description='Width of output image. Lower the setting if hits memory limits.')
    height: nodetool.nodes.replicate.image.generate.Kandinsky.Height = Field(default=nodetool.nodes.replicate.image.generate.Kandinsky.Height(512), description='Height of output image. Lower the setting if hits memory limits.')
...
class Kandinsky_2_2(GraphNode):
    ...
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Leave blank to randomize the seed')
    width: nodetool.nodes.replicate.image.generate.Kandinsky_2_2.Width = Field(default=nodetool.nodes.replicate.image.generate.Kandinsky_2_2.Width(512), description='Width of output image. Lower the setting if hits memory limits.')
    height: nodetool.nodes.replicate.image.generate.Kandinsky_2_2.Height = Field(default=nodetool.nodes.replicate.image.generate.Kandinsky_2_2.Height(512), description='Height of output image. Lower the setting if hits memory limits.')
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='A moss covered astronaut with a black background', description='Input prompt')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of images to output.')
...
class Photon_Flash(GraphNode):
    ...
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Set for reproducible generation')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Text prompt for image generation')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Photon_Flash.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Photon_Flash.Aspect_ratio('16:9'), description='Aspect ratio of the generated image')
...
class Proteus_V_03(GraphNode):
    ...
    scheduler: nodetool.nodes.replicate.image.generate.Proteus_V_03.Scheduler = Field(default=nodetool.nodes.replicate.image.generate.Proteus_V_03.Scheduler('DPM++2MSDE'), description='scheduler')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of images to output.')
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=7.5, description='Scale for classifier-free guidance. Recommended 7-8')
    apply_watermark: bool | GraphNode | tuple[GraphNode, str] = Field(default=True, description='Applies a watermark to enable determining if an image is generated in downstream applications. If you have other provisions for generating or deploying images safely, you can use this to disable watermarking.')
    negative_prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='worst quality, low quality', description='Negative Input prompt')
...
class PulidBase(GraphNode):
    ...
    face_style: nodetool.nodes.replicate.image.generate.PulidBase.Face_style = Field(default=nodetool.nodes.replicate.image.generate.PulidBase.Face_style('high-fidelity'), description='Style of the face')
    ...
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(default=80, description='Quality of the output images, from 0 to 100. 100 is best quality, 0 is lowest quality.')
    negative_prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='', description='Things you do not want to see in your image')
    checkpoint_model: nodetool.nodes.replicate.image.generate.PulidBase.Checkpoint_model = Field(default=nodetool.nodes.replicate.image.generate.PulidBase.Checkpoint_model('general - dreamshaperXL_alpha2Xl10'), description='Model to use for the generation')
...
class Recraft_20B(GraphNode):
    ...
    size: nodetool.nodes.replicate.image.generate.Recraft_20B.Size = Field(default=nodetool.nodes.replicate.image.generate.Recraft_20B.Size('1024x1024'), description='Width and height of the generated image')
...
class Recraft_20B_SVG(GraphNode):
    ...
    size: nodetool.nodes.replicate.image.generate.Recraft_20B_SVG.Size = Field(default=nodetool.nodes.replicate.image.generate.Recraft_20B_SVG.Size('1024x1024'), description='Width and height of the generated image')
...
class Recraft_V3(GraphNode):
    ...
    size: nodetool.nodes.replicate.image.generate.Recraft_V3.Size = Field(default=nodetool.nodes.replicate.image.generate.Recraft_V3.Size('1024x1024'), description='Width and height of the generated image')
...
class Recraft_V3_SVG(GraphNode):
    ...
    size: nodetool.nodes.replicate.image.generate.Recraft_V3_SVG.Size = Field(default=nodetool.nodes.replicate.image.generate.Recraft_V3_SVG.Size('1024x1024'), description='Width and height of the generated image')
...
class SDXL_Ad_Inpaint(GraphNode):
    ...
    img_size: nodetool.nodes.replicate.image.generate.SDXL_Ad_Inpaint.Img_size = Field(default=nodetool.nodes.replicate.image.generate.SDXL_Ad_Inpaint.Img_size('1024, 1024'), description='Possible SDXL image sizes')
...
class StableDiffusion(GraphNode):
    ...
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Leave blank to randomize the seed')
    width: nodetool.nodes.replicate.image.generate.StableDiffusion.Width = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusion.Width(768), description='Width of generated image in pixels. Needs to be a multiple of 64')
    height: nodetool.nodes.replicate.image.generate.StableDiffusion.Height = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusion.Height(768), description='Height of generated image in pixels. Needs to be a multiple of 64')
...
class StableDiffusion3_5_Large(GraphNode):
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Large.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Large.Aspect_ratio('1:1'), description='The aspect ratio of your output image. This value is ignored if you are using an input image.')
...
class StableDiffusion3_5_Medium(GraphNode):
    ...
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='', description='Text prompt for image generation')
    aspect_ratio: nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Medium.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Medium.Aspect_ratio('1:1'), description='The aspect ratio of your output image. This value is ignored if you are using an input image.')
...
class StableDiffusionInpainting(GraphNode):
    ...
    width: nodetool.nodes.replicate.image.generate.StableDiffusionInpainting.Width = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusionInpainting.Width(512), description='Width of generated image in pixels. Needs to be a multiple of 64')
    height: nodetool.nodes.replicate.image.generate.StableDiffusionInpainting.Height = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusionInpainting.Height(512), description='Height of generated image in pixels. Needs to be a multiple of 64')
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='a vision of paradise. unreal engine', description='Input prompt')
