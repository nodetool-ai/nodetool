...
class CodeFormer(GraphNode):
    image: ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=ImageRef(type="image", uri="", asset_id=None), description="Input image"
    )
...
from nodetool.nodes.replicate.image.enhance import AnthropicModel


class Maxim(GraphNode):
    image: ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=ImageRef(type="image", uri="", asset_id=None),
