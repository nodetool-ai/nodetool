...
from nodetool.nodes.replicate.image.upscale import Handfix
...
from nodetool.nodes.replicate.image.upscale import Output_format
...
class ClarityUpscaler(GraphNode):
    ...
    sd_model: Sd_model | GraphNode | tuple[GraphNode, str] = Field(default=Sd_model('juggernaut_reborn.safetensors [338b85bc4f]'), description='Stable Diffusion model checkpoint')
    scheduler: Scheduler | GraphNode | tuple[GraphNode, str] = Field(default=Scheduler('DPM++ 3M SDE Karras'), description='scheduler')
    ...
    tiling_width: Tiling_width | GraphNode | tuple[GraphNode, str] = Field(default=Tiling_width(112), description='Fractality, set lower tile width for a high Fractality')
    output_format: Output_format | GraphNode | tuple[GraphNode, str] = Field(default=Output_format('png'), description='Format of the output images')
    tiling_height: Tiling_height | GraphNode | tuple[GraphNode, str] = Field(default=Tiling_height(144), description='Fractality, set lower tile height for a high Fractality')
...
class HighResolutionControlNetTile(GraphNode):
    ...
    resolution: Resolution | GraphNode | tuple[GraphNode, str] = Field(default=Resolution(2048), description='Image resolution')
...
class MagicImageRefiner(GraphNode):
    ...
    guess_mode: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='In this mode, the ControlNet encoder will try best to recognize the content of the input image even if you remove all prompts. The `guidance_scale` between 3.0 and 5.0 is recommended.')
    resolution: Resolution | GraphNode | tuple[GraphNode, str] = Field(default=Resolution('original'), description='Image resolution')
...
class UltimateSDUpscale(GraphNode):
    ...
    mode_type: Mode_type | GraphNode | tuple[GraphNode, str] = Field(default=Mode_type('Linear'), description='Mode Type')
    scheduler: Scheduler | GraphNode | tuple[GraphNode, str] = Field(default=Scheduler('normal'), description='Scheduler')
    ...
    sampler_name: Sampler_name | GraphNode | tuple[GraphNode, str] = Field(default=Sampler_name('euler'), description='Sampler')
    tile_padding: int | GraphNode | tuple[GraphNode, str] = Field(default=32, description='Tile Padding')
    seam_fix_mode: Seam_fix_mode | GraphNode | tuple[GraphNode, str] = Field(default=Seam_fix_mode('None'), description='Seam Fix Mode')
