...
class SpeechToText(GraphNode):
    ...
    language: nodetool.nodes.openai.audio.SpeechToText.TTSLanguage = Field(default=nodetool.nodes.openai.audio.SpeechToText.TTSLanguage('auto_detect'), description='The language of the input audio')
...
class TextToSpeech(GraphNode):
    ...
    model: nodetool.nodes.openai.audio.TextToSpeech.TtsModel = Field(default=nodetool.nodes.openai.audio.TextToSpeech.TtsModel('tts-1'), description=None)
