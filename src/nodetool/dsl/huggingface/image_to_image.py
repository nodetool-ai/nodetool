...
class StableDiffusionControlNetImg2ImgNode(GraphNode):
    ...
    StableDiffusionScheduler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionControlNetImg2ImgNode.StableDiffusionScheduler
    StableDiffusionUpscaler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionControlNetImg2ImgNode.StableDiffusionUpscaler
    ...
    scheduler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionControlNetImg2ImgNode.StableDiffusionScheduler = Field(default=StableDiffusionScheduler.EulerDiscreteScheduler, description='The scheduler to use for the diffusion process.')
    ...
    upscaler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionControlNetImg2ImgNode.StableDiffusionUpscaler = Field(default=StableDiffusionUpscaler.NONE, description='The upscaler to use for 2-pass generation.')
...
class StableDiffusionControlNetInpaintNode(GraphNode):
    ...
    StableDiffusionScheduler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionControlNetInpaintNode.StableDiffusionScheduler
    StableDiffusionUpscaler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionControlNetInpaintNode.StableDiffusionUpscaler
    StableDiffusionControlNetModel: typing.ClassVar[type] = nodetool.nodes.huggingface.image_to_image.StableDiffusionControlNetInpaintNode.StableDiffusionControlNetModel
    model: HFStableDiffusion | GraphNode | tuple[GraphNode, str] = Field(default=HFStableDiffusion(type='hf.stable_diffusion', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The model to use for image generation.')
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='', description='The prompt for image generation.')
    negative_prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='(blurry, low quality, deformed, mutated, bad anatomy, extra limbs, bad proportions, text, watermark, grainy, pixelated, disfigured face, missing fingers, cropped image, bad lighting', description='The negative prompt to guide what should not appear in the generated image.')
    seed: int | GraphNode | tuple[GraphNode, str] = Field(default=-1, description='Seed for the random number generator. Use -1 for a random seed.')
    num_inference_steps: int | GraphNode | tuple[GraphNode, str] = Field(default=25, description='Number of denoising steps.')
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=7.5, description='Guidance scale for generation.')
    scheduler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionControlNetInpaintNode.StableDiffusionScheduler = Field(default=StableDiffusionScheduler.EulerDiscreteScheduler, description='The scheduler to use for the diffusion process.')
    loras: list[HFLoraSDConfig] | GraphNode | tuple[GraphNode, str] = Field(default=[], description='The LoRA models to use for image processing')
    ip_adapter_model: HFIPAdapter | GraphNode | tuple[GraphNode, str] = Field(default=HFIPAdapter(type='hf.ip_adapter', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The IP adapter model to use for image processing')
    ip_adapter_image: ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=ImageRef(type='image', uri='', asset_id=None, data=None), description='When provided the image will be fed into the IP adapter')
    ip_adapter_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=0.5, description='The strength of the IP adapter')
    ...
    enable_tiling: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Enable tiling for the VAE. This can reduce VRAM usage.')
    enable_cpu_offload: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Enable CPU offload for the pipeline. This can reduce VRAM usage.')
    upscaler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionControlNetInpaintNode.StableDiffusionUpscaler = Field(default=StableDiffusionUpscaler.NONE, description='The upscaler to use for 2-pass generation.')
    controlnet: nodetool.nodes.huggingface.image_to_image.StableDiffusionControlNetInpaintNode.StableDiffusionControlNetModel = Field(default=StableDiffusionControlNetModel.INPAINT, description='The ControlNet model to use for guidance.')
...
class StableDiffusionControlNetNode(GraphNode):
    ...
    StableDiffusionScheduler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionControlNetNode.StableDiffusionScheduler
    StableDiffusionUpscaler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionControlNetNode.StableDiffusionUpscaler
    model: HFStableDiffusion | GraphNode | tuple[GraphNode, str] = Field(default=HFStableDiffusion(type='hf.stable_diffusion', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The model to use for image generation.')
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='', description='The prompt for image generation.')
    negative_prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='(blurry, low quality, deformed, mutated, bad anatomy, extra limbs, bad proportions, text, watermark, grainy, pixelated, disfigured face, missing fingers, cropped image, bad lighting', description='The negative prompt to guide what should not appear in the generated image.')
    seed: int | GraphNode | tuple[GraphNode, str] = Field(default=-1, description='Seed for the random number generator. Use -1 for a random seed.')
    num_inference_steps: int | GraphNode | tuple[GraphNode, str] = Field(default=25, description='Number of denoising steps.')
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=7.5, description='Guidance scale for generation.')
    scheduler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionControlNetNode.StableDiffusionScheduler = Field(default=StableDiffusionScheduler.EulerDiscreteScheduler, description='The scheduler to use for the diffusion process.')
    loras: list[HFLoraSDConfig] | GraphNode | tuple[GraphNode, str] = Field(default=[], description='The LoRA models to use for image processing')
    ip_adapter_model: HFIPAdapter | GraphNode | tuple[GraphNode, str] = Field(default=HFIPAdapter(type='hf.ip_adapter', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The IP adapter model to use for image processing')
    ip_adapter_image: ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=ImageRef(type='image', uri='', asset_id=None, data=None), description='When provided the image will be fed into the IP adapter')
    ip_adapter_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=0.5, description='The strength of the IP adapter')
    ...
    enable_tiling: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Enable tiling for the VAE. This can reduce VRAM usage.')
    enable_cpu_offload: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Enable CPU offload for the pipeline. This can reduce VRAM usage.')
    upscaler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionControlNetNode.StableDiffusionUpscaler = Field(default=StableDiffusionUpscaler.NONE, description='The upscaler to use for 2-pass generation.')
    controlnet: HFControlNet | GraphNode | tuple[GraphNode, str] = Field(default=HFControlNet(type='hf.controlnet', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The ControlNet model to use for guidance.')
...
class StableDiffusionImg2ImgNode(GraphNode):
    ...
    StableDiffusionScheduler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionImg2ImgNode.StableDiffusionScheduler
    StableDiffusionUpscaler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionImg2ImgNode.StableDiffusionUpscaler
    model: HFStableDiffusion | GraphNode | tuple[GraphNode, str] = Field(default=HFStableDiffusion(type='hf.stable_diffusion', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The model to use for image generation.')
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='', description='The prompt for image generation.')
    negative_prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='(blurry, low quality, deformed, mutated, bad anatomy, extra limbs, bad proportions, text, watermark, grainy, pixelated, disfigured face, missing fingers, cropped image, bad lighting', description='The negative prompt to guide what should not appear in the generated image.')
    seed: int | GraphNode | tuple[GraphNode, str] = Field(default=-1, description='Seed for the random number generator. Use -1 for a random seed.')
    num_inference_steps: int | GraphNode | tuple[GraphNode, str] = Field(default=25, description='Number of denoising steps.')
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=7.5, description='Guidance scale for generation.')
    scheduler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionImg2ImgNode.StableDiffusionScheduler = Field(default=StableDiffusionScheduler.EulerDiscreteScheduler, description='The scheduler to use for the diffusion process.')
    loras: list[HFLoraSDConfig] | GraphNode | tuple[GraphNode, str] = Field(default=[], description='The LoRA models to use for image processing')
    ip_adapter_model: HFIPAdapter | GraphNode | tuple[GraphNode, str] = Field(default=HFIPAdapter(type='hf.ip_adapter', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The IP adapter model to use for image processing')
    ip_adapter_image: ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=ImageRef(type='image', uri='', asset_id=None, data=None), description='When provided the image will be fed into the IP adapter')
    ip_adapter_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=0.5, description='The strength of the IP adapter')
    ...
    enable_tiling: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Enable tiling for the VAE. This can reduce VRAM usage.')
    enable_cpu_offload: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Enable CPU offload for the pipeline. This can reduce VRAM usage.')
    upscaler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionImg2ImgNode.StableDiffusionUpscaler = Field(default=StableDiffusionUpscaler.NONE, description='The upscaler to use for 2-pass generation.')
...
class StableDiffusionInpaintNode(GraphNode):
    ...
    StableDiffusionScheduler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionInpaintNode.StableDiffusionScheduler
    StableDiffusionUpscaler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionInpaintNode.StableDiffusionUpscaler
    model: HFStableDiffusion | GraphNode | tuple[GraphNode, str] = Field(default=HFStableDiffusion(type='hf.stable_diffusion', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The model to use for image generation.')
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='', description='The prompt for image generation.')
    negative_prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='(blurry, low quality, deformed, mutated, bad anatomy, extra limbs, bad proportions, text, watermark, grainy, pixelated, disfigured face, missing fingers, cropped image, bad lighting', description='The negative prompt to guide what should not appear in the generated image.')
    seed: int | GraphNode | tuple[GraphNode, str] = Field(default=-1, description='Seed for the random number generator. Use -1 for a random seed.')
    num_inference_steps: int | GraphNode | tuple[GraphNode, str] = Field(default=25, description='Number of denoising steps.')
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=7.5, description='Guidance scale for generation.')
    scheduler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionInpaintNode.StableDiffusionScheduler = Field(default=StableDiffusionScheduler.EulerDiscreteScheduler, description='The scheduler to use for the diffusion process.')
    loras: list[HFLoraSDConfig] | GraphNode | tuple[GraphNode, str] = Field(default=[], description='The LoRA models to use for image processing')
    ip_adapter_model: HFIPAdapter | GraphNode | tuple[GraphNode, str] = Field(default=HFIPAdapter(type='hf.ip_adapter', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The IP adapter model to use for image processing')
    ip_adapter_image: ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=ImageRef(type='image', uri='', asset_id=None, data=None), description='When provided the image will be fed into the IP adapter')
    ip_adapter_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=0.5, description='The strength of the IP adapter')
    ...
    enable_tiling: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Enable tiling for the VAE. This can reduce VRAM usage.')
    enable_cpu_offload: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Enable CPU offload for the pipeline. This can reduce VRAM usage.')
    upscaler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionInpaintNode.StableDiffusionUpscaler = Field(default=StableDiffusionUpscaler.NONE, description='The upscaler to use for 2-pass generation.')
    init_image: ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=ImageRef(type='image', uri='', asset_id=None, data=None), description='The initial image to be inpainted.')
    mask_image: ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=ImageRef(type='image', uri='', asset_id=None, data=None), description='The mask image indicating areas to be inpainted.')
...
class StableDiffusionUpscale(GraphNode):
    ...
    StableDiffusionScheduler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionUpscale.StableDiffusionScheduler
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='', description='The prompt for image generation.')
    ...
    scheduler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionUpscale.StableDiffusionScheduler = Field(default=StableDiffusionScheduler.HeunDiscreteScheduler, description='The scheduler to use for the diffusion process.')
    seed: int | GraphNode | tuple[GraphNode, str] = Field(default=-1, description='Seed for the random number generator. Use -1 for a random seed.')
...
class StableDiffusionXLControlNetNode(GraphNode):
    ...
    StableDiffusionScheduler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionXLControlNetNode.StableDiffusionScheduler
    ...
    scheduler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionXLControlNetNode.StableDiffusionScheduler = Field(default=StableDiffusionScheduler.EulerDiscreteScheduler, description='The scheduler to use for the diffusion process.')
...
class StableDiffusionXLImg2Img(GraphNode):
    ...
    StableDiffusionScheduler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionXLImg2Img.StableDiffusionScheduler
    model: HFStableDiffusionXL | GraphNode | tuple[GraphNode, str] = Field(default=HFStableDiffusionXL(type='hf.stable_diffusion_xl', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The Stable Diffusion XL model to use for generation.')
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='', description='The prompt for image generation.')
    negative_prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='', description='The negative prompt to guide what should not appear in the generated image.')
    seed: int | GraphNode | tuple[GraphNode, str] = Field(default=-1, description='Seed for the random number generator.')
    ...
    width: int | GraphNode | tuple[GraphNode, str] = Field(default=1024, description='Width of the generated image.')
    height: int | GraphNode | tuple[GraphNode, str] = Field(default=1024, description='Height of the generated image')
    scheduler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionXLImg2Img.StableDiffusionScheduler = Field(default=StableDiffusionScheduler.EulerDiscreteScheduler, description='The scheduler to use for the diffusion process.')
    loras: list[HFLoraSDXLConfig] | GraphNode | tuple[GraphNode, str] = Field(default=[], description='The LoRA models to use for image processing')
    lora_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=0.5, description='Strength of the LoRAs')
    ip_adapter_model: HFIPAdapter | GraphNode | tuple[GraphNode, str] = Field(default=HFIPAdapter(type='hf.ip_adapter', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The IP adapter model to use for image processing')
    ip_adapter_image: ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=ImageRef(type='image', uri='', asset_id=None, data=None), description='When provided the image will be fed into the IP adapter')
...
class StableDiffusionXLInpainting(GraphNode):
    ...
    StableDiffusionScheduler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionXLInpainting.StableDiffusionScheduler
    model: HFStableDiffusionXL | GraphNode | tuple[GraphNode, str] = Field(default=HFStableDiffusionXL(type='hf.stable_diffusion_xl', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The Stable Diffusion XL model to use for generation.')
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='', description='The prompt for image generation.')
    negative_prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='', description='The negative prompt to guide what should not appear in the generated image.')
    seed: int | GraphNode | tuple[GraphNode, str] = Field(default=-1, description='Seed for the random number generator.')
    ...
    width: int | GraphNode | tuple[GraphNode, str] = Field(default=1024, description='Width of the generated image.')
    height: int | GraphNode | tuple[GraphNode, str] = Field(default=1024, description='Height of the generated image')
    scheduler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionXLInpainting.StableDiffusionScheduler = Field(default=StableDiffusionScheduler.EulerDiscreteScheduler, description='The scheduler to use for the diffusion process.')
    loras: list[HFLoraSDXLConfig] | GraphNode | tuple[GraphNode, str] = Field(default=[], description='The LoRA models to use for image processing')
    lora_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=0.5, description='Strength of the LoRAs')
    ip_adapter_model: HFIPAdapter | GraphNode | tuple[GraphNode, str] = Field(default=HFIPAdapter(type='hf.ip_adapter', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The IP adapter model to use for image processing')
    ip_adapter_image: ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=ImageRef(type='image', uri='', asset_id=None, data=None), description='When provided the image will be fed into the IP adapter')
