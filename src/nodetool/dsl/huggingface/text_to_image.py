...
class StableDiffusion(GraphNode):
    ...
    StableDiffusionScheduler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusion.StableDiffusionScheduler
    StableDiffusionUpscaler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusion.StableDiffusionUpscaler
    ...
    scheduler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusion.StableDiffusionScheduler = Field(default=StableDiffusionScheduler.EulerDiscreteScheduler, description='The scheduler to use for the diffusion process.')
    ...
    upscaler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusion.StableDiffusionUpscaler = Field(default=StableDiffusionUpscaler.NONE, description='The upscaler to use for 2-pass generation.')
...
class StableDiffusionXL(GraphNode):
    ...
    StableDiffusionScheduler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionXL.StableDiffusionScheduler
    ...
    scheduler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionXL.StableDiffusionScheduler = Field(default=StableDiffusionScheduler.EulerDiscreteScheduler, description='The scheduler to use for the diffusion process.')
